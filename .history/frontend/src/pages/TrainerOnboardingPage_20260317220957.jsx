...
import TrainerOnboardingWizard from "../components/onboarding/trainer/TrainerOnboardingWizard";
...
export default function TrainerOnboardingPage() {
  ...
  return (
    <div className="relative min-h-screen w-full overflow-x-hidden bg-black">
      ...
      {error ? (
        <div className="relative z-10 w-full mb-4 border-y border-red-500/20 bg-red-500/10 px-4 py-3 text-sm text-red-100">
          {error}
        </div>
      ) : null}
