...
export default function TrainerDetailPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-zinc-900 to-black text-zinc-200 relative overflow-x-hidden">
      <FloatingElements />
      <ScrollProgress />
      <ScrollToTop />

      <section className="relative pt-8 sm:pt-12 lg:pt-16 pb-10">
        <div className="w-full px-5 sm:px-8 lg:px-16 xl:px-20 2xl:px-24">
          <div className="mt-6 flex flex-col lg:grid lg:grid-cols-[400px_minmax(0,1fr)] 2xl:grid-cols-[430px_minmax(0,1fr)] gap-8 lg:gap-12 2xl:gap-16 items-start">
            <div className="order-1 lg:sticky lg:top-24 self-start w-full min-w-0">
              <ProfileSideCard
                data={data}
            ...
            <motion.div
              className="order-2 space-y-8 lg:space-y-10 xl:space-y-12 w-full min-w-0"
              style={{ y: heroY }}
            >
      ...
      <section
        id="booking-section"
        className="relative px-5 sm:px-8 lg:left-1/2 lg:right-1/2 lg:w-screen lg:max-w-none lg:-translate-x-1/2 lg:overflow-x-hidden lg:px-0 py-2 sm:py-4 lg:py-6"
      >
      ...
      <section className="relative pt-6 pb-6 sm:pt-8 lg:pt-10">
        <div className="w-full px-5 sm:px-8 lg:px-16 xl:px-20 2xl:px-24">
          <div className="lg:grid lg:grid-cols-[400px_minmax(0,1fr)] 2xl:grid-cols-[430px_minmax(0,1fr)] gap-8 lg:gap-12 2xl:gap-16">
            <div className="hidden lg:block" />
