...
export default function TrainerDetailPage() {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-black via-zinc-900 to-black text-zinc-200">
      ...
      <section className="relative pb-10 pt-8 sm:pt-12 lg:pb-16 lg:pt-16">
        <div className="w-full px-5 sm:px-8 lg:px-16 xl:px-20 2xl:px-24">
          <div className="mt-6 flex flex-col items-start gap-8 lg:grid lg:grid-cols-[400px_1fr] lg:gap-12 2xl:grid-cols-[430px_1fr] 2xl:gap-16">
            ...
            >
              <div className="lg:hidden">
                <ScrollReveal delay={0.08}>
                  <div className="pt-1">
                    <h1 className="text-3xl font-bold tracking-tight leading-tight text-zinc-100 sm:text-4xl">
                      {data.full_name}
                    </h1>
                    ...
                    {data.bio ? (
                      <p className="mt-3 max-w-4xl text-sm leading-relaxed text-zinc-300 sm:text-base">
                        {data.bio}
                      </p>
                    ) : null}
                  </div>
              ...
              <div className="hidden lg:block">
                <ScrollReveal delay={0.08}>
                  <div className="pt-1">
                    <h1 className="text-4xl font-bold tracking-tight leading-tight text-zinc-100 sm:text-5xl xl:text-6xl 2xl:text-7xl">
                      {data.full_name}
                    </h1>
      ...
      <section className="hidden lg:block lg:py-2">
        <div className="w-full px-5 sm:px-8 lg:px-16 xl:px-20 2xl:px-24">
          <div className="lg:grid lg:grid-cols-[400px_1fr] lg:gap-12 2xl:grid-cols-[430px_1fr] 2xl:gap-16">
            <div />
      ...
      <section className="relative pb-6 pt-6 sm:pt-8 lg:pt-10">
        <div className="w-full px-5 sm:px-8 lg:px-16 xl:px-20 2xl:px-24">
          <div className="lg:grid lg:grid-cols-[400px_1fr] lg:gap-12 2xl:grid-cols-[430px_1fr] 2xl:gap-16">
            <div className="hidden lg:block" />
            <div className="w-full space-y-8 lg:space-y-10 xl:space-y-12">
