                  ...
                  <LazySection>
                    ...
                    >
                      <div className="space-y-5">
                        ...
                        <div
  className={[
    "-mx-5 mt-3 px-5 py-4 sm:mx-0 sm:mt-0 sm:rounded-2xl sm:border sm:p-3",
    selectedDaysDirty ? "halo sm:border-white/10" : "sm:border-white/10 sm:bg-black/30",
  ].join(" ")}
>
...
<div className="-mx-5 mt-3 px-5 py-5 sm:mx-0 sm:mt-0 sm:rounded-2xl sm:border sm:border-white/10 sm:bg-zinc-800/20 sm:p-6">
...
<div className="-mx-5 mt-3 px-5 py-5 sm:mx-0 sm:mt-0 sm:rounded-2xl sm:border sm:border-white/10 sm:bg-zinc-800/20 sm:p-6">
  <div className="flex items-start justify-between gap-4 sm:items-center">
    <div className="flex min-w-0 items-start gap-4">
      ...
      <div className="min-w-0">
        <div className="text-[15px] font-semibold text-white sm:text-base">Μετρητά</div>
        <div className="mt-1 text-[13px] leading-6 text-zinc-400 sm:mt-1.5 sm:text-sm sm:leading-7">
...
<div className={breakDirty ? "halo rounded-2xl p-2 -m-2" : ""}>
  <label className="mb-3 block text-sm font-medium text-white">Διάλειμμα</label>
  <div className="grid grid-cols-2 gap-2">
