...
function PremiumCard({
  ...
  return (
    <motion.div
      ...
      className={[
        "w-full h-full flex flex-col group relative overflow-visible sm:overflow-hidden transition-all duration-300",
    ...
    >
      ...
      {(title || subtitle || icon || action) && (
        <button
          ...
          className={cn(
            "relative mb-5 flex w-full items-center justify-between gap-3 pl-1 sm:pl-0 text-left",
            headerClickable ? "cursor-pointer" : "cursor-default"
          )}
        >
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            {headerClickable && (
              <div className="flex h-10 w-10 items-center justify-center rounded-2xl border border-white/10 bg-white/5 text-white/85">
                <ChevronDown
                  className={cn(
...
function FieldLabel({ label, icon }) {
  return (
    <label className="text-sm font-medium text-white flex items-center gap-2">
      {icon && <span className="text-white">{icon}</span>}
      {label}
...
function PickerShell({ dirty, children }) {
  return (
    <div className={cn("space-y-2", dirty ? "halo p-2 -m-2 rounded-2xl" : "")}>
      {children}
    </div>
  );
}
    ...
    <PickerShell dirty={dirty}>
      ...
      <div className="relative" ref={wrapRef}>
        <button
          ...
          onClick={() => setOpen((v) => !v)}
          className={cn(
            "w-full rounded-2xl border border-white/20 bg-black/50 backdrop-blur-sm px-4 py-3 text-white transition-all duration-200 focus:border-white focus:ring-2 focus:ring-white/20 focus:outline-none",
            "flex items-center justify-between gap-3 text-left"
          )}
        >
          <span className="text-lg sm:text-base font-medium">{value}</span>
        ...
        <AnimatePresence>
          {open && (
            <motion.div
              ...
              className={cn(
                "absolute z-[70] mt-2 overflow-hidden rounded-3xl border border-white/10 bg-zinc-950/98 backdrop-blur-2xl shadow-[0_24px_80px_rgba(0,0,0,.55)]",
                isMobile ? "left-0 right-0" : "right-0 w-[320px]"
              )}
            >
                    ...
                    {hours.map((h) => {
                      ...
                      return (
                        <button
                          ...
                          onClick={() => setHour(h)}
                          className={cn(
                            "w-full rounded-2xl px-3 py-2.5 text-sm font-semibold transition text-center",
                            active
                              ? "bg-white text-black"
    ...
    <PickerShell dirty={dirty}>
      ...
      <div className="relative" ref={wrapRef}>
        <button
          type="button"
          onClick={() => setOpen((v) => !v)}
          className="w-full rounded-2xl border border-white/20 bg-black/50 backdrop-blur-sm px-4 py-3 text-white transition-all duration-200 focus:border-white focus:ring-2 focus:ring-white/20 focus:outline-none flex items-center justify-between gap-3 text-left"
        >
          <span className="text-lg sm:text-base font-medium">{value}</span>
          <span className="flex h-9 w-9 items-center justify-center rounded-xl border border-white/10 bg-white/5 text-white/75">
        ...
        <AnimatePresence>
          {open && (
            <motion.div
              ...
              className={cn(
                "absolute z-[70] mt-2 overflow-hidden rounded-3xl border border-white/10 bg-zinc-950/98 backdrop-blur-2xl shadow-[0_24px_80px_rgba(0,0,0,.55)]",
                isMobile ? "left-0 right-0" : "left-0 w-[340px]"
              )}
            >
              <div className="flex items-center justify-between border-b border-white/10 px-3 py-3">
                <button
                  type="button"
                  onClick={prevMonth}
                  className="flex h-10 w-10 items-center justify-center rounded-2xl bg-white/5 text-white hover:bg-white/10"
                >
...
export default function TrainerSchedulePage() {
  ...
  useEffect(() => {
    ...
    if (initializedRef.current && lastTrainerIdRef.current === profile.id)
      return;
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 sm:gap-6 items-stretch">
                  <LazySection>
                    <PremiumCard
                      ...
                      onHeaderClick={() => toggleSection("availability")}
                      action={
                        <PremiumButton
                          variant="outline"
                          onClick={() =>
                    ...
                    >
                      <div className="space-y-5">
                        ...
                        <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2 text-center sm:text-left">
                          <span className="w-full sm:w-auto text-xs sm:text-sm text-zinc-400 mr-1">
                            Γρήγορη επιλογή:
                          </span>
                          {[
                            {
                  ...
                  <LazySection>
                    <PremiumCard
                      ...
                      onHeaderClick={() => toggleSection("pricing")}
                    >
                      <div className="space-y-5">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          <PremiumInput
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 sm:gap-6 items-stretch">
                  <LazySection>
                    <PremiumCard
                      ...
                      onHeaderClick={() => toggleSection("schedule")}
                    >
                      <div className="space-y-5">
                        <div className={slotDirty ? "halo rounded-2xl p-2 -m-2" : ""}>
                          <label className="text-sm font-medium text-white mb-3 block text-center sm:text-left">
                            Διάρκεια συνεδρίας
                          </label>
                        ...
                        <div className={breakDirty ? "halo rounded-2xl p-2 -m-2" : ""}>
                          <label className="mb-3 block text-sm font-medium text-white text-center sm:text-left">
                            Διάλειμμα
                          </label>
                          <div className="grid grid-cols-2 gap-2">
                  ...
                  <LazySection>
                    <PremiumCard
                      ...
                      dirty={holidayDirty}
                      headerClickable
                      isOpen={openSections.holidays}
                      onHeaderClick={() => toggleSection("holidays")}
                    >
                      <div className="space-y-5">
                        ...
                        {holidays.length > 0 && (
                          <div className="space-y-2">
                            <h4 className="text-sm font-medium text-white text-center sm:text-left">
                              Υπάρχουσες άδειες
                            </h4>
