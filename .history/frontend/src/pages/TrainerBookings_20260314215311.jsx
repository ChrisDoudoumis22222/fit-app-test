...
function CalendarStage({ view, childrenMap }) {
  ...
  return (
    <div className="relative h-full min-h-[420px] sm:min-h-[520px] lg:min-h-[560px]">
      {[...mounted].map((k) => {
  ...
  <ErrorBoundary>
    <Suspense fallback={<Spinner />}>
      ...
      />
                ...
                <div className="self-stretch min-h-0 h-full px-1.5 sm:px-0">
                  <div className={`${sidebarShellClass} h-full`}>
                    <div
