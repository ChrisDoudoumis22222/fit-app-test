    ...
    <div className="relative min-h-screen text-gray-100">
      ...
      <div className="relative min-h-screen overflow-x-hidden">
        <div className="lg:pl-[calc(var(--side-w)+8px)] pl-0 pt-0 -mt-4 sm:mt-0 transition-[padding,margin]">
          <main className="w-full px-0 sm:px-6 lg:px-8 pt-2 pb-[120px] space-y-3 sm:space-y-8">
            <motion.header
              initial={{ opacity: 0, y: -20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            {allPosts.length === 0 ? (
              ...
              <>
                ...
                <section className="mobile-full-bleed grid grid-cols-1 gap-5 sm:gap-8 sm:grid-cols-2 lg:grid-cols-3">
