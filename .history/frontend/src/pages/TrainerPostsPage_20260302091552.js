    ...
    <div className="relative min-h-screen text-gray-100">
      ...
      <div className="relative min-h-screen overflow-x-hidden">
        <div className="lg:pl-[calc(var(--side-w)+8px)] pl-0 pt-0 -mt-4 sm:mt-0 transition-[padding,margin]">
          <main className="mx-auto max-w-7xl w-full px-4 pt-2 pb-[120px] sm:p-6 space-y-2 sm:space-y-8">
            {/* Header */}
            <motion.header
              initial={{ opacity: 0, y: -20 }}
              animate={{ opacity: 1, y: 0 }}
              className="relative pt-1 sm:pt-0"
            >
            ...
            {showCreator && (
              <div ref={composeRef}>
                <motion.div
                  ...
                  className={`group relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-b from-zinc-900/60 to-black/60 backdrop-blur-xl p-6 shadow-2xl ${
                    isCreateDirty ? "halo" : ""
                  }`}
                >
