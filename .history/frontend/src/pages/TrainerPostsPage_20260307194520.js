  ...
  >
    <div
      className="
        ...
        max-w-none sm:max-w-lg md:max-w-xl lg:max-w-3xl
      "
    >
  ...
  const addFiles = useCallback((fileList) => {
    ...
    if (rejected.length > 0) {
      setErrorPopup({
        ...
        message:
          "Μερικά αρχεία δεν μπόρεσαν να προστεθούν επειδή είναι μεγαλύτερα από 1MB ή δεν είναι εικόνες.",
...
<div className="space-y-1 sm:space-y-2 min-w-0">
  ...
  <div className="mt-10 sm:mt-0 flex items-center gap-2 text-xs sm:text-sm text-zinc-400">
    ...
    <span>Ζώνη ώρας: Ελλάδα (UTC+3)</span>
            ...
            {showCreator && (
              <div ref={composeRef} className="w-full">
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                  ...
                  className={[
                    ...
                    "sm:rounded-3xl sm:border sm:border-white/10 sm:bg-gradient-to-b sm:from-zinc-900/60 sm:to-black/60 sm:backdrop-blur-xl sm:shadow-2xl",
                    isCreateDirty ? "halo sm:rounded-3xl" : "",
                  ].join(" ")}
                >
                    ...
                    <div className="flex items-center gap-4 min-w-0">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-xs sm:text-sm text-zinc-300 mt-1 break-words">
                          Προσθέστε τίτλο, περιγραφή και εικόνες
                        </p>
                      </div>
                    </div>
                  ...
                  <form onSubmit={createPost} className="space-y-6">
                    ...
                    <Field
                      ...
                      value={desc}
                      onChange={setDesc}
                      dirty={createDescDirty}
                    />

                    <div
                      className={
                        createImagesDirty ? "halo rounded-2xl p-2 -m-2" : ""
                      }
                    >
                      <div className="space-y-4">
                        <label className="block text-sm font-medium text-zinc-300">
                        ...
                        >
                          ...
                          <div className="flex flex-col items-center text-zinc-400 group-hover:text-zinc-300 transition-colors text-center px-4">
                            ...
                            <p className="text-sm text-zinc-500">
                              Υποστήριξη πολλαπλών εικόνων • Μέγιστο 1MB η κάθε
                              μία
                            </p>
                          </div>
                        </label>
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
                          {thumbs.map((src, i) => (
                            <EnhancedThumb
                              ...
                              total={thumbs.length}
                              onOpen={() =>
                                setViewer({ open: true, imgs: thumbs, idx: i })
                              }
