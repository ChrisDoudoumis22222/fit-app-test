...
export default function TrainerDetailPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-gradient-to-br from-black via-zinc-900 to-black text-zinc-200">
      <FloatingElements />
      <ScrollProgress />
      <ScrollToTop />

      <section className="relative pb-10 pt-6 sm:pt-10 lg:pt-16">
        <div className="w-full px-4 sm:px-6 lg:px-16 xl:px-20 2xl:px-24">
          <div className="mt-4 flex flex-col items-start gap-6 md:mt-6 lg:grid lg:grid-cols-[400px_minmax(0,1fr)] lg:gap-12 2xl:grid-cols-[430px_minmax(0,1fr)] 2xl:gap-16">
            <div className="order-1 w-full min-w-0 self-start lg:sticky lg:top-24">
              <ProfileSideCard
                data={data}
            ...
            <motion.div
              className="order-2 w-full min-w-0 space-y-6 sm:space-y-8 lg:space-y-10 xl:space-y-12"
              style={{ y: heroY }}
            >
              ...
              <div className="lg:hidden">
                <ScrollReveal delay={0.08}>
                  <div className="px-1 pt-1">
                    <h1 className="text-3xl font-bold leading-tight tracking-tight text-zinc-100 sm:text-4xl">
                      {data.full_name}
                    </h1>

                    <p className="mt-2 text-base font-semibold text-zinc-400 sm:text-lg">
      ...
      {/* MOBILE: full bleed booking, no size restriction */}
      <section
        id="booking-section"
        className="relative left-1/2 w-screen max-w-none -translate-x-1/2 overflow-x-hidden px-0 py-2 sm:py-4 lg:hidden"
      >
      ...
      {/* DESKTOP: keep restriction only here, aligned with right column */}
      <section className="hidden lg:block lg:py-6">
        <div className="w-full px-5 sm:px-8 lg:px-16 xl:px-20 2xl:px-24">
          <div className="lg:grid lg:grid-cols-[400px_minmax(0,1fr)] lg:gap-12 2xl:grid-cols-[430px_minmax(0,1fr)] 2xl:gap-16">
            <div className="hidden lg:block" />
            <div id="booking-section" className="w-full min-w-0">
              <AllInOneBooking
                trainerId={data.id}
                trainerName={data.full_name}
                holidays={holidays}
      ...
      <section className="relative pb-6 pt-6 sm:pt-8 lg:pt-10">
        <div className="w-full px-4 sm:px-6 lg:px-16 xl:px-20 2xl:px-24">
          <div className="lg:grid lg:grid-cols-[400px_minmax(0,1fr)] lg:gap-12 2xl:grid-cols-[430px_minmax(0,1fr)] 2xl:gap-16">
            <div className="hidden lg:block" />
            <div className="w-full min-w-0 space-y-8 lg:space-y-10 xl:space-y-12">
