...
import StatsSection from "../components/trainer-detail/StatsSection.jsx"
...
export default function TrainerDetailPage() {
  ...
  const [, setHasAvailableSlots] = useState(true)
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-black via-zinc-900 to-black text-zinc-200">
        ...
        <div className="mx-auto max-w-4xl space-y-4 px-4 py-16 sm:py-24">
          ...
          <button
            onClick={() => navigate(-1)}
            className="inline-flex items-center gap-2 rounded-lg border border-zinc-600/50 bg-zinc-800/50 px-4 py-2 text-zinc-200 transition-colors duration-150 hover:bg-zinc-700/50"
          >
      ...
      <section className="relative hidden pb-10 pt-8 sm:pt-12 lg:block lg:pb-16 lg:pt-16">
        <div className="w-full px-5 sm:px-8 lg:px-16 xl:px-20 2xl:px-24">
          <div className="mt-6 grid items-start gap-12 lg:grid-cols-[400px_1fr] 2xl:grid-cols-[430px_1fr] 2xl:gap-16">
            ...
            <div className="order-2 w-full space-y-8 lg:space-y-10 xl:space-y-12">
              {/* # PART 6.1.1 — HERO */}
              <div className="pt-1">
