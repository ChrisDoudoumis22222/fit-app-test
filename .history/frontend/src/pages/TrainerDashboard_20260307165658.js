            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full rounded-2xl bg-white/5 border border-white/10 px-4 pr-12 py-3 text-sm text-white placeholder-white/30 outline-none focus:bg-white/7 focus:ring-2 focus:ring-white/20"
                ...
                <button
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 rounded-xl p-1.5 text-white/65 hover:text-white hover:bg-white/10"
                  disabled={saving}
                  aria-label={showNext ? "Απόκρυψη κωδικού" : "Εμφάνιση κωδικού"}
                >
                  {showNext ? (
