...
export default function UserBookingDetailsDock({
  ...
  useEffect(() => {
    ...
    const incomingHasEnoughData =
      incomingBooking &&
      safeId(incomingBooking) === id &&
      incomingBooking.date &&
      incomingBooking.start_time &&
      incomingBooking.trainer &&
      typeof incomingBooking.trainer === "object";

    if (incomingHasEnoughData) {
      ...
      try {
        ...
        if (bookingData.trainer_id) {
          ...
          if (!profileError && profileData) {
            trainerProfile = normalizeProfile(profileData);
          }
        }
