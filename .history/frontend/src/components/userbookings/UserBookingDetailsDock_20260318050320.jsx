...
function Button({
  ...
  const base =
    "inline-flex items-center justify-center rounded-xl font-medium transition-none focus:outline-none focus:ring-2 focus:ring-white/20 disabled:cursor-not-allowed disabled:opacity-60";
...
const variants = {
  ...
  danger:
    "border border-rose-400/20 bg-rose-600/90 text-white shadow-[0_6px_18px_rgba(244,63,94,.25)]",
          ...
          {status === "accepted" && !!calendarUrl && (
            <div className="mb-4">
              <Button
                ...
                className="flex h-12 w-full items-center justify-center gap-3 border border-white/20 bg-white text-black transition-none"
              >
