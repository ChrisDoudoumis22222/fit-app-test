  ...
  return (
    <div className={cn("relative z-[20]", className)}>
      <button
        ...
        onClick={() => setOpen((v) => !v)}
        className={cn(
          "flex w-full items-center justify-between gap-3 rounded-2xl border border-white/20 bg-black/50 px-4 py-3 text-left text-white backdrop-blur-sm transition-all duration-200 focus:border-white focus:outline-none focus:ring-2 focus:ring-white/20 disabled:cursor-not-allowed disabled:opacity-60",
          buttonClassName
        )}
      >
          ...
          {open && panelStyle && (
            <>
              ...
              <motion.div
                ...
                style={panelStyle}
                className={cn(
                  "overflow-hidden rounded-3xl border border-white/10 bg-zinc-950/98 shadow-[0_24px_80px_rgba(0,0,0,.55)] backdrop-blur-2xl",
