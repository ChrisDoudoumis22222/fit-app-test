      ...
      <div className="absolute inset-0 flex items-center justify-center p-4 sm:p-6">
        <div
          className="
            ...
            rounded-3xl border border-red-400/20
            bg-[#0b0b0b]/95
          ...
          <div className="flex flex-col items-center text-center sm:items-start sm:text-left">
            <div
              className="
                ...
                rounded-full bg-red-500/15 ring-1 ring-red-400/20
                sm:h-12 sm:w-12
              "
            >
              <AlertCircle className="h-7 w-7 text-red-400 sm:h-6 sm:w-6" />
            </div>
            ...
            <p className="mt-2 text-sm leading-6 text-red-100/90 sm:text-sm">
              {message}
            </p>
