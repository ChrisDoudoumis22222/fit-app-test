      ...
      <div className="mb-2.5 flex items-center justify-between">
        ...
        <div className="flex items-center gap-1.5">
          <button
            type="button"
            onClick={onIncrement}
            className="flex h-8 w-8 items-center justify-center rounded-xl border border-white/10 bg-white/[0.04] text-white/78 transition hover:bg-white/[0.08] hover:text-white"
          >
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  selected ? "text-white" : "text-white/72 hover:text-white/92"
                )}
              ...
              >
                ...
                <div className="p-3.5 sm:p-4">
                  ...
                  <div className="mt-3.5 rounded-[22px] border border-white/10 bg-white/[0.025] px-4 py-3 backdrop-blur-md">
                    <div className="text-[10px] uppercase tracking-[0.15em] text-white/38">
                      Preview
                    </div>
                ...
                <div className="flex items-center justify-between gap-3 border-t border-white/10 px-3.5 py-3 sm:px-4">
                  <button
                    type="button"
                    onClick={handleNow}
                    className="rounded-2xl border border-white/10 bg-white/[0.04] px-4 py-2.5 text-sm font-medium text-white/82 transition hover:bg-white/[0.08] hover:text-white"
                  >
                    Τώρα
                  </button>
