      ...
      <div className="absolute inset-0 flex items-center justify-center p-4 sm:p-6">
        ...
        >
          <div className="pointer-events-none absolute inset-0">
            <div className="absolute left-1/2 top-0 h-[170px] w-[170px] -translate-x-1/2 rounded-full bg-red-500/6 blur-3xl" />
            <div className="absolute inset-x-0 top-0 h-[130px] bg-gradient-to-b from-red-500/[0.03] to-transparent" />
          </div>
          ...
          <div className="relative z-10 px-5 pb-6 pt-8 sm:px-7 sm:pb-7 sm:pt-9">
            <div className="flex flex-col items-center text-center">
              <div className="relative flex h-[108px] w-[108px] items-center justify-center sm:h-[118px] sm:w-[118px]">
                <div className="absolute h-[108px] w-[108px] rounded-full bg-red-400/7" />
                <div className="absolute h-[82px] w-[82px] rounded-full bg-red-400/10" />
                <div className="absolute h-[60px] w-[60px] rounded-full bg-red-400/14" />
                <div className="absolute flex h-[50px] w-[50px] items-center justify-center rounded-full bg-red-500 shadow-[0_8px_24px_rgba(239,68,68,0.24)]">
            ...
            <div className="mt-6 rounded-[20px] bg-[#262b31] px-4 py-4 text-left">
