...
export default function SuccessMessage({
  ...
  subtitle = "Η προπόνηση καταχωρήθηκε επιτυχώς μέσω του Peak Velocity.",
  calendarEvent = null,
}) {
        ...
        >
          ...
          <div className="relative z-10 px-5 pb-6 pt-8 sm:px-7 sm:pb-7 sm:pt-9">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="mt-5 max-w-[320px] text-[15px] font-medium leading-6 text-emerald-300 sm:text-[16px]">
                {message}
              </p>
            </div>
