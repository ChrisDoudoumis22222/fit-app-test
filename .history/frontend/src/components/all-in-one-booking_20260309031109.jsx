...
const ActionButton = ({
  ...
  const variants = {
    primary:
      "bg-white/75 text-black hover:bg-white/85 shadow-[0_8px_24px_rgba(255,255,255,0.08)] sm:bg-white sm:hover:bg-zinc-100 sm:shadow-[0_8px_24px_rgba(255,255,255,0.12)]",
    secondary:
