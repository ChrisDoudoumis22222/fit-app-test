...
function SemiGauge({
  ...
  return (
    <div className="relative mx-auto w-full max-w-[210px] sm:max-w-[228px]">
      <svg
        viewBox="0 0 280 180"
      ...
      <div className="pointer-events-none absolute inset-0 flex flex-col items-center justify-center pt-5 sm:pt-6">
        <AnimatedNumber
          value={Number(current || 0)}
          duration={1.2}
          delay={delay}
          className={cn(
            "text-[1.55rem] font-bold tracking-tight sm:text-[1.8rem]",
            theme.number
          )}
        />
        ...
        {subLabel ? (
          <div className="mt-1 text-center text-[10px] text-zinc-400 sm:text-[11px]">
            {subLabel}
          </div>
        ) : null}
      </div>
  ...
  return (
    <div className="relative overflow-hidden rounded-[1.5rem] border border-zinc-800 bg-zinc-900/95 p-3.5 sm:p-4">
      <div className="space-y-3.5">
        <div className="rounded-[1.2rem] border border-zinc-800 bg-black/20 p-3">
          <div className="mb-3 flex items-center justify-between gap-2">
            <SkeletonPulse className="h-6 w-20 rounded-full" />
            <SkeletonPulse className="h-7 w-7 rounded-full" />
          </div>
          <SkeletonPulse className="mx-auto h-[96px] w-[180px] rounded-[999px]" />
        </div>
  ...
  return (
    ...
    >
      ...
      <div className="relative flex h-full flex-col">
        {/* compact hero */}
        <div className="relative rounded-[1.2rem] border border-zinc-800 bg-[linear-gradient(180deg,rgba(0,0,0,0.18),rgba(255,255,255,0.01))] p-3">
        ...
        <div className="pt-3">
          <h3
            className="text-[1.05rem] font-bold leading-[1.15] tracking-tight text-white sm:text-[1.15rem]"
            title={goal.title}
          >
            {goal.title}
          </h3>
        ...
        <div className="mt-3 flex flex-wrap gap-2">
          {goal.category === "custom" && (
            <div className="inline-flex items-center gap-1.5 rounded-full border border-zinc-700 bg-zinc-800/80 px-2.5 py-1 text-[10px] font-medium text-zinc-300">
          ...
          {goal.unit && (
            <div className="inline-flex items-center rounded-full border border-zinc-700 bg-zinc-800/80 px-2.5 py-1 text-[10px] font-medium text-zinc-300">
              Μονάδα: {goal.unit}
            </div>
          )}
        </div>
...
function LazyGoalCard(props) {
  ...
  return (
    <div ref={ref} className="min-h-[355px] sm:min-h-[390px]">
