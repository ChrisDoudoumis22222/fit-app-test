    ...
    <FieldShell label={label} icon={icon}>
      <div className="relative">
        <select
          value={value}
          onChange={onChange}
          className="w-full appearance-none px-4 py-3 pr-11 bg-zinc-900/60 border border-white/10 rounded-2xl text-zinc-100 focus:outline-none focus:border-white/30 focus:ring-2 focus:ring-white/20 transition-all duration-200 backdrop-blur-xl"
        >
          {options.map((option) => (
            ...
            <div className="fixed inset-0 z-[120] sm:hidden">
              ...
              <div className="absolute inset-x-0 bottom-0 flex justify-center">
                <motion.div
                  ...
                  onClick={(e) => e.stopPropagation()}
                  className="w-full border border-zinc-900 bg-black shadow-[0_-30px_80px_rgba(0,0,0,.9)] flex flex-col overflow-hidden rounded-t-[30px] h-[92dvh] will-change-transform"
                >
                  <div
                    className="flex justify-center bg-black pt-2 pb-1 cursor-grab active:cursor-grabbing"
                  ...
                  <div
                    className="border-b border-zinc-800/90 bg-black px-4 pt-3 pb-4 cursor-grab active:cursor-grabbing"
                    style={{ touchAction: "none" }}
                    onPointerDown={(e) => dragControls.start(e)}
                  >
