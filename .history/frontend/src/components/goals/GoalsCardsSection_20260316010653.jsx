...
function GoalStatusPill({ label, theme }) {
  return (
    <span
      className={cn(
        "inline-flex items-center rounded-full border px-2.5 py-1 text-[9px] font-bold uppercase tracking-[0.08em] sm:px-3 sm:py-1.5 sm:text-[11px]",
        theme.pill
      )}
    >
      {label}
...
const GoalCard = memo(function GoalCard({
  ...
  return (
    <motion.article
      ...
      whileHover={{ y: -2 }}
      className="group relative h-full overflow-hidden rounded-[1.4rem] border border-zinc-700 bg-zinc-900 p-4 sm:rounded-[1.75rem] sm:p-6"
    >
      <div className="relative flex h-full flex-col">
        ...
        <div className="mb-4 flex items-start justify-between gap-3 sm:mb-5">
          <div className="min-w-0 flex-1">
            <div className="mb-2 flex items-center gap-2">
              <GoalIconRenderer
                ...
                icon={goal.icon}
                className="h-[18px] w-[18px] text-zinc-200 sm:h-5 sm:w-5"
              />
          ...
          >
            <motion.button
              ...
              className="flex h-9 w-9 items-center justify-center rounded-xl border border-zinc-700 bg-zinc-800 text-zinc-300 transition hover:bg-zinc-700 hover:text-white"
        ...
        <div className="mt-auto">
          {!isCompleted ? (
            ...
            <div className="flex w-full items-center justify-center gap-2 rounded-[999px] border border-zinc-600 bg-zinc-800 px-4 py-3.5 text-sm font-semibold text-zinc-100 sm:px-5 sm:py-4 sm:text-base">
              <CheckCircle className="h-4 w-4" />
