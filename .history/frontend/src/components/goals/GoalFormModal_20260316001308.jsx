...
export default function GoalFormModal({ open, onClose, initial, onSubmit }) {
  ...
  const moveMobileGesture = (clientY) => {
    ...
    if (dragRef.current.source === "content" && !dragRef.current.engaged) {
      ...
      const shouldCollapseFromTop = startMode === "full" && scrollTop <= 0 && rawDelta > 14;
      const shouldCloseFromMid = startMode === "mid" && scrollTop <= 0 && rawDelta > 14;
            ...
            <div className="fixed inset-0 z-[120] sm:hidden">
              ...
              <div className="absolute inset-x-0 bottom-0 flex justify-center pointer-events-none">
                <motion.div
                  ...
                  onClick={(e) => e.stopPropagation()}
                  className={cn(
                    "w-full border border-zinc-900 bg-black shadow-[0_-30px_80px_rgba(0,0,0,.9)] flex flex-col overflow-hidden rounded-t-[30px] pointer-events-auto will-change-transform",
                    mobileDragging
                      ? "transition-none"
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <div className="mt-1 text-sm text-zinc-300 leading-snug">
                          {mobileMode === "mid"
                            ? "Σύρε προς τα πάνω για 85%"
                            : "Σύρε προς τα κάτω για 50%"}
                        </div>
                      </div>
