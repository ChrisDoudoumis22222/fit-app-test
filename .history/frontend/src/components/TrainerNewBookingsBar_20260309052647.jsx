      ...
      >
        <Glass className="px-3 py-2.5 sm:px-4 sm:py-3">
          ...
          <div className="mb-2 flex items-center justify-between gap-3">
            ...
            <button
              className="inline-flex h-8 items-center gap-1.5 rounded-lg border border-white/10 bg-white/[.03] px-2.5 text-[11px] text-white/80 transition hover:bg-white/[.06]"
