    ...
    subtitle:
      truncateText(
        p?.caption ||
          ...
          p?.description ||
          p?.title ||
          "Ο trainer ανέβασε νέα ανάρτηση."
      ) || "Ο trainer ανέβασε νέα ανάρτηση.",
    target_id: p.id,
    target_type: "post",
    post_id: p.id,
  ...
  if (item.type === "booking") {
    ...
    return (
      ...
      >
        <div
          className={cn(
            "rounded-lg border p-3 backdrop-blur-md transition",
            meta.bg,
            meta.border,
            meta.hover,
...
sm:w-full sm:mx-0 sm:px-0
sm:rounded-xl sm:border sm:border-white/10 sm:bg-[#0b0b0f] sm:p-4
">
