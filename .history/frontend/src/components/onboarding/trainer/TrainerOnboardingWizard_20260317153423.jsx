...
export default function TrainerOnboardingWizard({
  ...
  return (
    <div className="relative min-h-[100svh] overflow-hidden bg-black text-white">
      ...
      <div className="relative z-10 mx-auto max-w-[1400px] px-4 py-4 sm:px-6 sm:py-6 lg:px-10 lg:py-10">
        <div className="lg:grid lg:min-h-[calc(100svh-5rem)] lg:grid-cols-[1.15fr_1fr] lg:gap-8">
          {/* ================= Mobile Top Hero ================= */}
          ...
          <div className="hidden lg:flex">
            <div className="relative flex w-full flex-col justify-between overflow-hidden rounded-[36px] border border-white/10 bg-white/[0.04] p-10 shadow-[0_30px_120px_rgba(0,0,0,0.6)] backdrop-blur-2xl">
          ...
          {/* ================= Right Form Panel ================= */}
          <div className="flex">
            <div className="flex w-full flex-col overflow-hidden rounded-[32px] border border-white/10 bg-zinc-950/85 shadow-[0_30px_120px_rgba(0,0,0,0.65)] backdrop-blur-2xl">
              {/* Form header */}
              ...
              {/* Form body */}
              <div className="flex-1 px-5 py-6 sm:px-7 sm:py-7 lg:px-8 lg:py-8">
