...
export default function TrainerOnboardingWizard({
  ...
  return (
    <div className="relative min-h-[100svh] overflow-hidden bg-black text-white">
      ...
      <div className="relative z-10 w-full px-4 py-4 sm:px-6 sm:py-6 lg:px-12 lg:py-8">
        <div className="lg:grid lg:min-h-[100svh] lg:grid-cols-[1.2fr_1fr] lg:gap-10 xl:grid-cols-[1.25fr_1fr]">
          {/* ================= Mobile Top Hero ================= */}
