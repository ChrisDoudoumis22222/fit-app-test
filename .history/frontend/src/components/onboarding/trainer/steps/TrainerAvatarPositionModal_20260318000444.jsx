...
export default function TrainerAvatarPositionModal({
  ...
  const circleSize = "58%";
  const clearRadius = 29%; // μισό του 58%
          ...
          >
            {imageUrl ? (
              <>
                ...
                {/* subtle base contrast */}
                <div className="pointer-events-none absolute inset-0 bg-black/5" />

                {/* clean outside blur mask */}
                <div
                  className="pointer-events-none absolute inset-0 bg-black/32 backdrop-blur-[7px]"
                  style={{
                    WebkitMaskImage: `radial-gradient(circle at center, transparent 0 ${clearRadius}%, black calc(${clearRadius}% + 1%), black 100%)`,
                    maskImage: `radial-gradient(circle at center, transparent 0 ${clearRadius}%, black calc(${clearRadius}% + 1%), black 100%)`,
                  }}
                />
                ...
                <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
                  <div
                    className="rounded-full border border-white/40 shadow-[0_0_0_1px_rgba(255,255,255,0.08),0_0_0_10px_rgba(0,0,0,0.18)]"
                    style={{
                      width: circleSize,
                      height: circleSize,
                    }}
                ...
                {/* soft inner vignette only inside visible circle */}
                <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
                  <div
