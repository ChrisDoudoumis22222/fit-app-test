...
export default function TrainerAvailabilityStep({
  ...
  return (
    <section className="-mx-4 px-4 md:mx-0 md:px-0">
      <div className="rounded-[28px] border border-zinc-900 bg-zinc-950/70 p-4 md:p-5">
        {/* Header */}
        <div className="mb-5">
          <div className="flex items-start gap-3">
            <div className="mt-0.5 flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl border border-zinc-800 bg-zinc-900 text-white">
            ...
            <div className="min-w-0">
              ...
              <div className="mt-3 flex flex-wrap items-center gap-2">
                <span className="rounded-full border border-zinc-800 bg-zinc-900 px-3 py-1 text-[11px] font-medium text-zinc-300 md:text-xs">
        ...
        <div className="space-y-3">
          {DAYS.map((day) => {
            ...
            return (
              <div
                key={day.key}
                className="rounded-[26px] border border-zinc-800 bg-black/40 p-4 md:px-4 md:py-4"
              >
                <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
                  {/* Left side */}
                  <div className="flex items-start gap-3 xl:min-w-[260px]">
                    <button
                      type="button"
                    ...
                    <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 xl:w-auto xl:min-w-[420px]">
                      <div className="rounded-2xl border border-zinc-800 bg-zinc-900/80 px-4 py-3">
                        ...
                        <input
                          ...
                          className="w-full border-0 bg-transparent p-0 text-sm font-medium text-white outline-none md:rounded-xl md:border md:border-zinc-800 md:bg-black/50 md:px-3 md:py-2.5 md:transition md:focus:border-zinc-700"
                        />
                      </div>
        ...
        {/* Lesson mode */}
        <div className="mt-4 rounded-[26px] border border-zinc-800 bg-black/40 p-4 md:p-5">
