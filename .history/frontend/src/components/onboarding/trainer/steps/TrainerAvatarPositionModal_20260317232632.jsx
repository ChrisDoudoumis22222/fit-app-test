  ...
  return (
    <div className="fixed inset-0 z-[200]">
      ...
      <div className="absolute left-1/2 top-1/2 w-[calc(100%-20px)] max-w-4xl -translate-x-1/2 -translate-y-1/2 overflow-hidden rounded-[30px] border border-white/10 bg-zinc-950 shadow-[0_35px_120px_rgba(0,0,0,0.65)]">
        ...
        <div className="grid grid-cols-1 gap-5 p-4 md:grid-cols-[minmax(0,1fr)_180px] md:gap-6 md:p-6">
          ...
          <div className="flex flex-col gap-4">
            <div className="rounded-[24px] border border-white/10 bg-white/[0.03] p-4">
              ...
              <div className="mx-auto relative h-32 w-32 overflow-hidden rounded-full border-2 border-white/15 bg-black">
                {imageUrl ? (
                  <img
                    src={imageUrl}
