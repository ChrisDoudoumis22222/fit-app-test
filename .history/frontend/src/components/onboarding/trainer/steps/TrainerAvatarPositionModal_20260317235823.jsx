            ...
            {imageUrl ? (
              <>
                ...
                <div
                  ...
                  style={{
                    background:
                      "radial-gradient(circle at center, rgba(0,0,0,0) 0 29%, rgba(156,163,175,0.18) 33%, rgba(90,90,90,0.34) 48%, rgba(45,45,45,0.48) 64%, rgba(18,18,18,0.58) 100%)",
                ...
                <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
                  <div
                    ...
                    style={{
                      boxShadow:
                        "0 0 0 9999px rgba(120,120,120,0.16)",
                    }}
                  />
                </div>
