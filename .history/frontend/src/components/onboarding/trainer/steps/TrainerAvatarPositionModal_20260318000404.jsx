...
export default function TrainerAvatarPositionModal({
  ...
  // Circle is 58% of the square => radius is ~29%
  const outsideCircleMask = {
    WebkitMaskImage:
      "radial-gradient(circle at center, transparent 0%, transparent 28.8%, black 31.2%, black 100%)",
    maskImage:
      "radial-gradient(circle at center, transparent 0%, transparent 28.8%, black 31.2%, black 100%)",
          ...
          >
            {imageUrl ? (
              <>
                ...
                {/* Blurred image ONLY outside the crop circle */}
                <img
                  src={imageUrl}
                  alt=""
                  aria-hidden="true"
                ...
                {/* Extra soft dark overlay only outside circle */}
                <div
                  className="pointer-events-none absolute inset-0 bg-black/18"
                  style={outsideCircleMask}
                />

                {/* Soft feather around circle */}
                <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
                  <div className="h-[58%] w-[58%] rounded-full shadow-[0_0_0_1px_rgba(255,255,255,0.78),0_0_0_10px_rgba(255,255,255,0.04),0_0_24px_rgba(0,0,0,0.18)]" />
                </div>

                {/* Final circle border */}
                <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
                  <div className="h-[58%] w-[58%] rounded-full border-2 border-white/85" />
                </div>
