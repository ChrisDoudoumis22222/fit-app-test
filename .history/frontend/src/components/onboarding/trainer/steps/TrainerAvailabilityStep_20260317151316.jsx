...
export default function TrainerAvailabilityStep({ form, setForm }) {
  ...
  const patchAvailability = (weekday, patch) => {
    setForm((prev) => {
      const current = Array.isArray(prev?.availability) && prev.availability.length
        ? prev.availability
        ...
        <div className="space-y-4">
            ...
            <div className="flex flex-wrap items-center justify-between gap-3">
              <div>
                ...
                <p className="text-xs text-zinc-400">
                  Έχεις ενεργοποιήσει {enabledCount} {enabledCount === 1 ? "ημέρα" : "ημέρες"}.
                </p>
              </div>
          ...
          <div className="rounded-2xl border border-zinc-800 bg-zinc-950/70 px-4 py-3">
            <p className="text-xs leading-6 text-zinc-400">
              Συμβουλή: Βάλε μόνο τις ημέρες που πραγματικά μπορείς να
              αναλαμβάνεις πελάτες. Μπορείς να το αλλάξεις αργότερα από το
              dashboard σου.
            </p>
          </div>
        </div>
