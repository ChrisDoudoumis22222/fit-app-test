      ...
      <div className="space-y-4 md:space-y-5">
        ...
        <div className="md:rounded-[28px] md:border md:border-zinc-900 md:bg-zinc-950/70 md:p-5">
          <div className="flex items-start gap-3">
            <div className="mt-0.5 flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl border border-zinc-800 bg-zinc-950 text-white md:h-11 md:w-11">
            ...
            <div className="min-w-0">
              ...
              <div className="mt-3 flex flex-wrap items-center gap-2">
                <span className="rounded-full border border-zinc-800 bg-zinc-950 px-3 py-1 text-[11px] font-medium text-zinc-300 md:text-xs">
          ...
          {DAYS.map((day) => {
            ...
            return (
              ...
              >
                ...
                {/* Times */}
                {row.enabled ? (
                  <div className="mt-4 grid grid-cols-2 gap-3 md:max-w-[520px]">
                    <div className="rounded-2xl border border-zinc-800 bg-black/70 p-3">
                      <label className="mb-2 flex items-center gap-2 text-[11px] font-medium uppercase tracking-[0.08em] text-zinc-400">
                      ...
                      <input
                        ...
                        className="w-full rounded-xl border border-zinc-800 bg-zinc-950 px-3 py-2.5 text-sm text-white outline-none transition focus:border-zinc-700"
                      />
                    </div>
                ...
                {row.slotCount > 1 ? (
                  <div className="mt-3 rounded-2xl border border-amber-900/30 bg-amber-950/30 px-3 py-2 text-xs leading-5 text-amber-200">
                ...
                {invalidTime ? (
                  <div className="mt-3 rounded-2xl border border-red-900/30 bg-red-950/30 px-3 py-2 text-xs leading-5 text-red-300">
        ...
        {/* Lesson mode */}
        <div className="rounded-[24px] border border-zinc-800 bg-zinc-950/80 p-4 md:rounded-[28px] md:p-5">
          <div className="mb-4 flex items-start gap-3">
            <div className="mt-0.5 flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl border border-zinc-800 bg-zinc-900 text-white">
              {globalIsOnline ? (
          ...
          <div className="grid grid-cols-2 gap-2.5">
            <button
              ...
              className={cn(
                ...
                !globalIsOnline
                  ? "bg-white text-black"
                  : "border border-zinc-800 bg-black text-white hover:border-zinc-700"
              )}
            >
              <MapPin className="h-4 w-4" />
              <span>Δια ζώσης</span>
