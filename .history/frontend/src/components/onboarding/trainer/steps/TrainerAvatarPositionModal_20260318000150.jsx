        ...
        <div className="flex items-start justify-between border-b border-white/10 px-5 py-5">
          <div className="pr-4">
            ...
            <p className="mt-3 text-sm text-zinc-400">
              Κούνησε πάνω στην εικόνα και χρησιμοποίησε μόνο το zoom
            </p>
          </div>
          ...
          >
            {imageUrl ? (
              <>
                ...
                {/* OUTSIDE OF CIRCLE ONLY */}
                <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
                  <div className="relative h-[58%] w-[58%] rounded-full">
                    {/* top */}
                    <div className="absolute left-1/2 top-[-9999px] h-[9999px] w-[220vw] -translate-x-1/2 bg-black/22 backdrop-blur-[10px]" />
                    {/* bottom */}
                    <div className="absolute bottom-[-9999px] left-1/2 h-[9999px] w-[220vw] -translate-x-1/2 bg-black/22 backdrop-blur-[10px]" />
                    {/* left */}
                    <div className="absolute right-full top-0 h-full w-[9999px] bg-black/22 backdrop-blur-[10px]" />
                    {/* right */}
                    <div className="absolute left-full top-0 h-full w-[9999px] bg-black/22 backdrop-blur-[10px]" />

                    {/* soft glow around the edge */}
                    <div className="absolute inset-0 rounded-full shadow-[0_0_0_1px_rgba(255,255,255,0.75),0_0_0_14px_rgba(255,255,255,0.05),0_0_30px_rgba(255,255,255,0.08)]" />
                  </div>
                </div>

                {/* clean visible circle */}
                <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
                  <div className="h-[58%] w-[58%] rounded-full border-2 border-white/90" />
                </div>
