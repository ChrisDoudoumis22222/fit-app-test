  ...
  return (
    <section className="-mx-4 px-4 md:mx-0 md:px-0">
      <div className="space-y-4 md:space-y-5">
        {/* Header χωρίς outer container */}
        <div>
          <div className="flex items-start gap-3">
            <div className="mt-0.5 flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl border border-zinc-800 bg-zinc-900 text-white md:h-11 md:w-11">
            ...
            <div className="min-w-0">
              ...
              <div className="mt-3 flex flex-wrap items-center gap-2">
                <span className="rounded-full border border-zinc-800 bg-zinc-900/80 px-3 py-1 text-[11px] font-medium text-zinc-300 md:text-xs">
          ...
          {DAYS.map((day) => {
            ...
            return (
              <div
                key={day.key}
                className={cn(
                  "rounded-[24px] border border-zinc-800 bg-zinc-900/55 p-4 backdrop-blur-sm",
                  "md:rounded-[28px] md:p-5"
                )}
              >
                <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                  {/* Left info */}
                  <div className="flex items-start justify-between gap-3 lg:min-w-[220px] lg:justify-start">
                    <div className="min-w-0">
                    ...
                    <button
                      ...
                      className={cn(
                        "relative h-8 w-14 shrink-0 rounded-full transition-colors lg:hidden",
                        row.enabled ? "bg-white" : "bg-zinc-700"
                      )}
                    ...
                    >
                      <span
                        className={cn(
                          ...
                          row.enabled ? "left-7 bg-black" : "left-1 bg-white"
                        )}
                      />
                    </button>
                  </div>
                  ...
                  {/* Times */}
                  {row.enabled ? (
                    <div className="grid grid-cols-2 gap-3 lg:w-[430px] lg:shrink-0">
                      <div className="rounded-2xl border border-zinc-700 bg-zinc-800/80 px-4 py-3">
                        <label className="mb-2 flex items-center gap-2 text-[11px] font-medium uppercase tracking-[0.08em] text-zinc-300">
                        ...
                        <input
                          ...
                          className="w-full border-0 bg-transparent p-0 text-sm font-medium text-white outline-none"
                        />
                      </div>
        ...
        {/* Lesson mode */}
        <div className="rounded-[24px] border border-zinc-800 bg-zinc-900/55 p-4 md:rounded-[28px] md:p-5">
          <div className="mb-4 flex items-start gap-3">
            <div className="mt-0.5 flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl border border-zinc-700 bg-zinc-800 text-white">
              {globalIsOnline ? (
          ...
          <div className="grid grid-cols-2 gap-2.5">
            <button
              ...
              className={cn(
                "flex min-h-[52px] items-center justify-center gap-2 rounded-2xl px-3 py-3 text-sm font-medium transition",
                !globalIsOnline
                  ? "bg-white text-black"
                  : "border border-zinc-700 bg-zinc-800/80 text-white hover:border-zinc-600"
              )}
            >
              <MapPin className="h-4 w-4" />
              <span>Δια ζώσης</span>
