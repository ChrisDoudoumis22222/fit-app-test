          ...
          >
            {imageUrl ? (
              <>
                ...
                {/* blurred outside circle */}
                <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
                  <div
                    className="h-[58%] w-[58%] rounded-full border border-white/60 shadow-[0_0_0_9999px_rgba(24,24,27,0.30)]"
                    style={{
                ...
                {/* soft blurred ring around the circle */}
                <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
                  <div
                    className="h-[68%] w-[68%] rounded-full"
                    style={{
                      boxShadow:
                        "0 0 0 9999px rgba(10,10,10,0.28), 0 0 40px rgba(255,255,255,0.10)",
                      backdropFilter: "blur(10px)",
                      WebkitBackdropFilter: "blur(10px)",
                      maskImage:
                        "radial-gradient(circle, transparent 0 42%, black 50%)",
                      WebkitMaskImage:
                        "radial-gradient(circle, transparent 0 42%, black 50%)",
                    }}
                  />
                ...
                {/* clean visible crop circle */}
                <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
                  <div className="h-[58%] w-[58%] rounded-full border-2 border-white/85 shadow-[0_0_30px_rgba(255,255,255,0.10)]" />
                </div>
