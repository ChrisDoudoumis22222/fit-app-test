                    ...
                    <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 xl:w-auto xl:min-w-[420px]">
                      <div className="rounded-2xl border border-zinc-800 bg-zinc-900/80 px-4 py-3">
                        ...
                        <input
                          ...
                          className="w-full rounded-xl border border-zinc-800 bg-black/50 px-3 py-2.5 text-sm font-medium text-white outline-none transition focus:border-zinc-700"
                        />
                      </div>
