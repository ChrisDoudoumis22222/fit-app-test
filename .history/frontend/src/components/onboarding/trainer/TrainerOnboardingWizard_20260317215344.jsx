    ...
    <div className="relative min-h-[100svh] overflow-hidden bg-zinc-900 text-white">
      ...
      <div className="relative z-10 flex min-h-[100svh] flex-col lg:hidden">
        ...
        <main className="flex-1 px-0 pt-3 pb-24">
          <div className="mb-3 bg-black/25 px-4 py-3 backdrop-blur-xl">
            <div className="flex items-center justify-between gap-3">
              <span className="rounded-full border border-zinc-700/60 bg-black/30 px-2.5 py-1 text-[9px] font-semibold uppercase tracking-[0.16em] text-zinc-300">
            ...
            <h1 className="mt-2.5 text-[1.18rem] font-extrabold leading-[1.08] text-white">
              {currentStep.title}
            </h1>

            <p className="mt-1.5 text-[11.5px] font-medium leading-5 text-zinc-400">
        ...
        <div className="sticky bottom-0 z-20 bg-black/35 px-3 pb-3 pt-2.5 backdrop-blur-2xl">
          <div className="rounded-[24px] border border-zinc-700/50 bg-black/40 p-2 shadow-[0_18px_50px_rgba(0,0,0,0.45)]">
            <div className="grid grid-cols-2 gap-2">
              <motion.button
                ...
                className={cn(
                  "inline-flex h-12 min-w-0 items-center justify-center gap-2 rounded-[18px] px-3 text-[13px] font-semibold transition-all",
              ...
              >
                ...
                <span className="truncate">Προηγούμενο</span>
              </motion.button>
              ...
              <motion.button
                ...
                className={cn(
                  "inline-flex h-12 min-w-0 items-center justify-center gap-2 rounded-[18px] px-3 text-[13px] font-semibold shadow-lg transition-all",
                  saving
              ...
              >
                {saving ? (
                  ...
                  <>
                    <span className="truncate">Ολοκλήρωση</span>
                    <Rocket className="h-4 w-4 shrink-0" />
                  </>
                ) : (
                  <>
                    <span className="truncate">Συνέχεια</span>
      ...
      <div className="relative z-10 hidden min-h-[100svh] lg:block">
        <div className="w-full px-6 py-6 xl:px-8 xl:py-8">
          ...
          <div className="mt-6">
            ...
            <div
              className="mt-8 rounded-3xl border border-zinc-700/50 bg-black/35 p-3
                         backdrop-blur-xl shadow-[0_20px_50px_rgba(0,0,0,0.35)]"
            >
              <div className="flex items-center justify-between gap-3">
                <motion.button
