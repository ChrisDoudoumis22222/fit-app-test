...
const Glass = ({ className = "", children }) => (
  <div
    className={[
      ...
      "md:bg-[rgba(17,18,21,.65)] md:backdrop-blur-xl",
      "md:shadow-[inset_0_1px_0_rgba(255,255,255,.04),0_10px_30px_rgba(0,0,0,.45)]",
      className,
    ].join(" ")}
  >
...
<div
  className={[
    ...
    "border-amber-400/25 bg-zinc-800/85",
    "transition-all duration-200",
    "hover:-translate-y-[1px] hover:bg-zinc-800/95 hover:border-amber-400/45",
...
>
        <div className="relative flex items-start gap-3">
          <div className="relative">
            ...
            <span className="absolute -left-0.5 -top-0.5 h-2.5 w-2.5 rounded-full bg-amber-400 shadow-[0_0_0_3px_rgba(251,191,36,0.25)]" />
          </div>
...
<span className="shrink-0 rounded-full border border-amber-400/20 bg-amber-500/10 px-2 py-0.5 text-[10px] font-medium text-amber-200">
  Εκκρεμεί
</span>
            </div>
