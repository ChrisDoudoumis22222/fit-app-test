      ...
      <div className="px-3 sm:px-4 space-y-4">
        ...
        <Tile className="space-y-4">
          <div>
            ...
            <div className="relative mt-1.5">
              <input
                type="date"
                className="quickbook-date w-full h-11 rounded-xl bg-zinc-900/55 px-3 pr-12 text-base text-white/90 focus:outline-none focus:ring-2 focus:ring-white/10"
                value={date}
        ...
        <Tile className="space-y-3">
          ...
          {!sched ? (
            ...
            <div className="bg-zinc-950/10 p-1 sm:p-2 rounded-xl">
