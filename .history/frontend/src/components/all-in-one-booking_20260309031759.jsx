    ...
    >
      ...
      <span
        className={cn(
          ...
          active ? "text-white/75 sm:text-white" : done ? "text-emerald-200" : "text-zinc-500 sm:text-zinc-400"
        )}
      >
        {label}
      </span>
...
const [notes, setNotes] = useState("");
  ...
  const [, setWeeklyAvailability] = useState([]);
  ...
  const handleContinue = async () => {
    ...
    if (!userId) {
      setBanner({
        ...
        message: "Συνδέσου για να ολοκληρώσεις την κράτηση.",
      });
      return;
    }
  ...
  return (
    <div className="w-full">
      ...
      <div className="w-full lg:mx-auto lg:max-w-7xl">
        ...
        >
{/* Gradient overlays - hidden on mobile for clean look */}
              ...
              <div className="px-0 py-0">
                <AnimatePresence mode="wait" initial={false}>
                  {!hasDateSelection ? (
                    ...
                    >
{/* Calendar container - more spacious on mobile */}
                      <div className="mx-auto w-full max-w-none xl:max-w-[980px]">
{/* Month header with improved mobile spacing */}
...
{/* Calendar weekday headers - more spacing on mobile */}
...
{/* Calendar grid - transparent backgrounds on mobile, contained on larger screens */}
                    ...
                    >
{/* Container removed on mobile for full-bleed green section */}
...
{/* Mobile full-bleed: spans full viewport on mobile, contained on sm+ */}
                      ...
                      >
                        {/* Container removed on mobile for full-bleed */}
                      ...
                      <motion.section
                        ...
                        className="space-y-6 px-0 py-5 sm:px-5 sm:py-6 lg:px-8 lg:py-8"
                      >
                        {/* Confirmation section - container removed on mobile for full-bleed green banner */}
                        <section className="border-0 bg-transparent p-0 sm:rounded-3xl sm:border sm:border-white/10 sm:bg-white/[0.02] sm:p-5 lg:rounded-none lg:border-0 lg:bg-transparent lg:p-0">
                          <div className="mb-4 flex items-start justify-between gap-4 px-4 sm:px-0">
                            <div>
                              <p className="text-xs uppercase tracking-[0.18em] text-zinc-500">
                          ...
                          <div className="grid gap-3 px-4 sm:grid-cols-2 sm:px-0 xl:grid-cols-3">
                            ...
                            <div className="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-4 sm:col-span-2 sm:border-white/8 sm:bg-white/[0.03] xl:col-span-1">
