      ...
      <PremiumCard
        ...
        action={
          <button
            ...
            className={cn(
              "inline-flex w-full items-center justify-center gap-2 px-0 py-0",
              "bg-transparent text-sm font-semibold text-white",
              "border-0 rounded-none shadow-none outline-none",
              "underline underline-offset-4 decoration-white/35 transition-all duration-200",
              "hover:text-white hover:decoration-white/70 active:scale-[0.98] sm:w-auto"
            )}
          >
