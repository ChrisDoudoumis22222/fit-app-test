...
export default function QuickBookModal({
  ...
  const submitBooking = async () => {
    ...
    const finalBookingPrice = getBookingPriceFromPricing(pricing, selectedSlot);

    if (finalBookingPrice == null) {
      setBanner({
        type: "error",
        title: "Μη έγκυρη τιμή",
        message: "Δεν ήταν δυνατός ο υπολογισμός της τιμής κράτησης.",
      });
      return;
    }
