...
{/* Mobile full-bleed: break out of container on mobile, contained on md+ */}
                        <div className="-mx-4 mb-5 border-y border-emerald-500/15 bg-emerald-500/10 px-4 py-4 sm:-mx-5 sm:px-5 md:mx-0 md:rounded-2xl md:border md:px-4">
                    ...
                    >
                      ...
                      <section className="rounded-3xl border border-white/10 bg-white/[0.02] p-4 sm:p-5 lg:rounded-none lg:border-0 lg:bg-transparent lg:p-0">
{/* Mobile full-bleed: break out of container on mobile, contained on md+ */}
                        <div className="-mx-4 mb-4 border-y border-emerald-500/15 bg-emerald-500/10 px-4 py-4 sm:-mx-5 sm:px-5 md:mx-0 md:rounded-2xl md:border md:px-4">
                          <div className="flex items-center gap-4">
                            <div className="flex h-10 w-10 items-center justify-center rounded-full bg-emerald-500/20">
                              <CheckCircle2 className="h-5 w-5 text-emerald-400" />
                            </div>
