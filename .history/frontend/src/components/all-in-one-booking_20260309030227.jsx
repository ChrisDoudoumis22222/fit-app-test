...
{/* Mobile full-bleed: spans full viewport on mobile, contained on sm+ */}
                    ...
                    <motion.section
                      ...
                      exit={{ opacity: 0, scale: 0.992 }}
                      transition={{ duration: 0.18, ease: "easeOut" }}
                      className="space-y-6 px-4 py-5 sm:px-5 sm:py-6 lg:px-8 lg:py-8"
                    >
                      <section className="rounded-3xl border border-white/10 bg-white/[0.02] p-4 sm:p-5 lg:rounded-none lg:border-0 lg:bg-transparent lg:p-0">
                      ...
                      <section className="rounded-3xl border border-white/10 bg-white/[0.02] p-4 sm:p-5 lg:rounded-none lg:border-0 lg:bg-transparent lg:p-0">
{/* Mobile full-bleed: no inner containers on mobile */}
                        <div className="-mx-4 mb-4 flex items-center gap-4 border-y border-emerald-500/15 bg-emerald-500/10 px-4 py-4 sm:-mx-5 sm:px-5 md:mx-0 md:rounded-2xl md:border md:px-4">
                          <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-emerald-500/20">
                            <CheckCircle2 className="h-5 w-5 text-emerald-400" />
                          </div>
                          <div>
