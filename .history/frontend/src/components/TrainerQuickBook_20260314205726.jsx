...
export default function TrainerQuickBook({
  ...
  const renderDesktopView = () => (
    <Glass className="overflow-hidden rounded-[28px] border border-white/10 hidden sm:block">
      <style>{`
        .quickbook-date-desktop {
          color-scheme: dark;
          -webkit-appearance: none;
          appearance: none;
        }

        .quickbook-date-desktop::-webkit-calendar-picker-indicator {
          opacity: 0;
          cursor: pointer;
          width: 44px;
          height: 100%;
        ...
        .quickbook-date-desktop::-webkit-datetime-edit,
        .quickbook-date-desktop::-webkit-datetime-edit-text,
        .quickbook-date-desktop::-webkit-datetime-edit-month-field,
        .quickbook-date-desktop::-webkit-datetime-edit-day-field,
        .quickbook-date-desktop::-webkit-datetime-edit-year-field {
          color: rgba(255,255,255,.9);
        }

        .quickbook-hours-scroll-desktop {
          scrollbar-width: thin;
          scrollbar-color: rgba(255,255,255,.10) transparent;
        }

        .quickbook-hours-scroll-desktop::-webkit-scrollbar {
          width: 8px;
        }

        .quickbook-hours-scroll-desktop::-webkit-scrollbar-track {
          background: transparent;
        }

        .quickbook-hours-scroll-desktop::-webkit-scrollbar-thumb {
          background: rgba(255,255,255,.10);
          border-radius: 999px;
        }

        .quickbook-hours-scroll-desktop::-webkit-scrollbar-thumb:hover {
      ...
      <div className="px-3 py-3 sm:px-4">
        <div className="flex flex-col gap-3">
          <div className="flex items-start gap-3">
            <div className="grid h-9 w-9 shrink-0 place-items-center rounded-xl bg-zinc-900/55">
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="mt-2 flex flex-wrap items-center gap-2">
                <span className="inline-flex items-center rounded-full bg-zinc-900/50 px-2.5 py-1 text-[11px] text-white/58">
                  Ωράριο: {niceWindows}
                </span>
          ...
          <button
            ...
            className="h-10 w-full sm:w-auto sm:self-start inline-flex items-center justify-center gap-2 rounded-xl bg-zinc-900/55 px-4 text-sm text-white/68 hover:bg-zinc-900/80 transition"
          >
      ...
      <div className="px-3 sm:px-4 space-y-4">
        <Tile className="space-y-4">
          <div>
            ...
            <div className="relative mt-1.5">
              <input
                type="date"
                className="quickbook-date-desktop w-full h-11 rounded-xl bg-zinc-900/55 px-3 pr-12 text-base text-white/90 focus:outline-none focus:ring-2 focus:ring-white/10"
                value={date}
          ...
          <div>
            ...
            <div className="mt-1.5 grid grid-cols-2 gap-2">
              <button
                ...
                className={[
                  "h-11 rounded-xl px-3 text-sm inline-flex items-center justify-center gap-2 transition",
                  !isOnline
                    ? "bg-white text-black shadow-[0_6px_18px_rgba(255,255,255,.08)]"
                    : "bg-zinc-900/55 text-white/68 hover:bg-zinc-900/80",
                ].join(" ")}
              >
        ...
        <Tile className="space-y-3">
          ...
          {!sched ? (
            ...
            <div className="px-1 py-2 text-sm text-white/50">
              Ρεπό / χωρίς ωράριο για αυτή τη μέρα.
            </div>
          ) : (
            <div className="bg-zinc-950/10 py-1 sm:py-2">
              <div className="quickbook-hours-scroll-desktop max-h-[42vh] overflow-y-auto pr-1 sm:pr-2">
                {loadingDay ? (
        ...
        <Tile className="space-y-3">
          <label className="block">
            ...
            <input
              ...
              className="mt-1.5 w-full h-11 rounded-xl bg-zinc-900/55 px-3 text-base text-white/90 placeholder-white/30 focus:outline-none focus:ring-2 focus:ring-white/10"
              value={email}
          ...
          <label className="block">
            ...
            <textarea
              ...
              className="mt-1.5 w-full rounded-xl bg-zinc-900/55 px-3 py-2.5 text-base text-white/90 placeholder-white/30 focus:outline-none focus:ring-2 focus:ring-white/10"
              value={note}
        ...
        {err && (
          <div className="rounded-xl bg-red-500/[.06] px-3 py-2 text-sm text-red-300">
            {err}
          </div>
        )}

        {okMsg && (
          <div className="inline-flex items-center gap-2 rounded-xl bg-emerald-500/[.06] px-3 py-2 text-sm text-emerald-300">
        ...
        <div className="flex flex-col gap-3 pb-4">
          ...
          <button
            ...
            disabled={saving}
            className="w-full h-11 rounded-xl bg-zinc-900/70 text-white hover:bg-zinc-800 disabled:opacity-60 text-[15px] font-medium transition"
          >
  ...
  const renderMobileSheet = () => {
    ...
    return createPortal(
      <>
        <style>{`
          .quickbook-date-mobile {
            color-scheme: dark;
            -webkit-appearance: none;
            appearance: none;
          }

          .quickbook-date-mobile::-webkit-calendar-picker-indicator {
            opacity: 0;
            cursor: pointer;
            width: 44px;
            height: 100%;
          ...
          .quickbook-date-mobile::-webkit-datetime-edit,
          .quickbook-date-mobile::-webkit-datetime-edit-text,
          .quickbook-date-mobile::-webkit-datetime-edit-month-field,
          .quickbook-date-mobile::-webkit-datetime-edit-day-field,
          .quickbook-date-mobile::-webkit-datetime-edit-year-field {
            color: #ffffff;
          }

          .quickbook-hours-scroll-mobile {
            scrollbar-width: thin;
            scrollbar-color: rgba(255,255,255,.14) transparent;
          }

          .quickbook-hours-scroll-mobile::-webkit-scrollbar {
            width: 6px;
          }

          .quickbook-hours-scroll-mobile::-webkit-scrollbar-track {
            background: transparent;
          }

          .quickbook-hours-scroll-mobile::-webkit-scrollbar-thumb {
        ...
        <div className="sm:hidden fixed inset-0 z-[999]">
          ...
          <div className="absolute inset-x-0 bottom-0">
            <div className="mx-auto w-full max-w-md rounded-t-[30px] border border-white/10 bg-[#070a11] shadow-[0_-30px_80px_rgba(0,0,0,.6)]">
              <div className="flex justify-center pt-2 pb-1">
                <div className="h-1.5 w-12 rounded-full bg-white/20" />
              </div>

              <div className="max-h-[92dvh] overflow-y-auto px-0 pb-[env(safe-area-inset-bottom)] text-white">
                {/* mobile header */}
                <div className="border-b border-white/10 px-4 pt-3 pb-4">
                  <div className="flex items-start gap-3">
                    <div className="grid h-10 w-10 shrink-0 place-items-center rounded-2xl bg-white/5">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="mt-2 flex flex-wrap items-center gap-2">
                        <span className="inline-flex items-center rounded-full bg-white/6 px-2.5 py-1 text-[11px] text-white">
                          Ωράριο: {niceWindows}
                        </span>

                        <span className="inline-flex items-center rounded-full bg-emerald-500/12 px-2.5 py-1 text-[11px] text-white">
                          {loadingDay || !sched ? "…" : `${availableCount} διαθέσιμες`}
                        </span>
                      </div>
                    </div>
                    ...
                    <button
                      type="button"
                      onClick={() => onMobileClose && onMobileClose()}
                      className="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl bg-white/5 text-white"
                    >
                      <X className="h-5 w-5" />
                    </button>
                  </div>
                ...
                <div className="space-y-4 px-4 py-4 text-white">
                  {/* mobile controls */}
                  <Tile className="rounded-[24px] border border-white/12 bg-white/[0.03] p-4 text-white">
                    <div className="space-y-4">
                      <div>
                        ...
                        <div className="relative mt-2">
                          <input
                            type="date"
                            className="quickbook-date-mobile w-full h-12 rounded-2xl border border-white/20 bg-white/[0.03] px-3 pr-12 text-base text-white focus:outline-none focus:ring-2 focus:ring-white/12"
                            value={date}
                            onChange={(e) => setDate(e.target.value)}
                          />
                          <Calendar className="pointer-events-none absolute right-3 top-1/2 -translate-y-1/2 h-4 w-4 text-white" />
                        </div>

                        <p className="mt-2 text-xs text-white">{shortDate}</p>
                      </div>
                    ...
                    <div className="space-y-3">
                      <div className="flex flex-wrap items-start justify-between gap-3">
                        <div className="min-w-0">
                          ...
                          <div className="mt-2 flex flex-wrap items-center gap-2">
                            ...
                            <span className="inline-flex items-center rounded-full bg-amber-500/12 px-2.5 py-1 text-[11px] text-white">
                              {busyCount} κατειλημμένες
                            </span>
                        ...
                        <button
                          ...
                          title="Ανανέωση διαθέσιμων"
                          onClick={() => setRefreshTick((t) => t + 1)}
                          className="h-10 shrink-0 inline-flex items-center justify-center gap-2 rounded-2xl border border-white/10 bg-white/[0.03] px-3 text-sm text-white transition"
                        >
                      ...
                      <div className="flex flex-wrap items-center gap-3 text-xs text-white">
                        ...
                        <span className="inline-flex items-center gap-1">
                          ...
                          <span className="text-white">Κατειλημμένες</span>
                        </span>
                        <span className="inline-flex items-center gap-1">
                          <span className="inline-block h-2.5 w-2.5 rounded-full bg-zinc-400/90" />
                          <span className="text-white">Διάλειμμα / Ρεπό</span>
                        </span>
                      </div>
                      ...
                      {!sched ? (
                        ...
                        <div className="bg-transparent">
                          <div className="quickbook-hours-scroll-mobile max-h-[30dvh] overflow-y-auto pr-1">
                            {loadingDay ? (
                              <Spinner label="Φόρτωση διαθεσιμότητας…" />
                            ) : (
                              <div className="grid grid-cols-3 gap-2">
                                {slots.map(({ s, e, status }) => {
                                  ...
                                  let cls =
                                    "h-11 rounded-2xl border text-sm transition px-2.5 text-center font-medium text-white"

                                  if (status === "rest") {
                                    cls += " border-white/8 bg-white/[0.03] text-white/45 cursor-not-allowed"
                                  } else if (status === "busy") {
                                    cls += " border-amber-500/15 bg-amber-500/12 text-white/80 cursor-not-allowed"
                                  } else if (isSel) {
                                    cls += " border-white/30 bg-white/12 text-white"
                                  } else {
                                  ...
                                  return (
                                    ...
                                    >
                                      <span className="text-white">{minToHHMM(s)}</span>
                                    </button>
                                  )
                                })}
                              </div>
                    ...
                    <div className="space-y-3">
                      <label className="block">
                        ...
                        <input
                          type="email"
                          placeholder="client@example.com"
                          className="mt-2 w-full h-12 rounded-2xl border border-white/20 bg-white/[0.03] px-3 text-base text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:ring-white/12"
                          value={email}
                          onChange={(e) => setEmail(e.target.value)}
                        />
                      ...
                      <label className="block">
                        ...
                        <textarea
                          rows={4}
                          placeholder="Οποιαδήποτε λεπτομέρεια"
                          className="mt-2 w-full rounded-2xl border border-white/20 bg-white/[0.03] px-3 py-3 text-base text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:ring-white/12"
                          value={note}
                          onChange={(e) => setNote(e.target.value)}
                        />
                      </label>
                  ...
                  {err && (
                    <div className="rounded-2xl border border-red-400/20 bg-red-500/10 px-3 py-3 text-sm text-white">
                      {err}
                    </div>
                  )}

                  {okMsg && (
                    <div className="flex items-center gap-2 rounded-2xl border border-emerald-400/20 bg-emerald-500/10 px-3 py-3 text-sm text-white">
                      <Check className="h-4 w-4 shrink-0 text-white" />
                      <span className="flex-1 text-white">{okMsg}</span>
                      <button
                        type="button"
                  ...
                  <div className="sticky bottom-0 z-10 -mx-4 border-t border-white/10 bg-[#070a11]/95 px-4 pt-3 pb-[calc(env(safe-area-inset-bottom)+12px)] backdrop-blur-xl">
                    <div className="flex flex-col gap-3">
                      ...
                      <button
                        ...
                        onClick={handleCreate}
                        disabled={saving}
                        className="w-full h-12 rounded-2xl border border-white/20 bg-white/10 text-white disabled:opacity-60 text-[15px] font-semibold transition"
                      >
                        {saving ? "Αποθήκευση..." : "Καταχώριση"}
                      </button>
                    </div>
