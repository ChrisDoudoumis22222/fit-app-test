...
const variants = {
  primary:
    "bg-transparent text-emerald-400 border border-emerald-400/40 hover:bg-emerald-400/10",

  secondary:
    "bg-white/[0.05] hover:bg-white/[0.08] text-white border border-white/8",

  danger:
    "bg-transparent text-rose-400 border border-rose-400/40 hover:bg-rose-400/10",
