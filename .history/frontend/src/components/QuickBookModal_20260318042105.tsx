...
const loadPricing = useCallback(async () => {
  ...
  try {
    ...
    const { data, error } = await supabase
      ...
      .eq("trainer_id", trainerIdCandidates[0])
  ...
  useEffect(() => {
    ...
    if (!trainerId) {
      setBanner({
        ...
        message: "Δεν βρέθηκε σωστό trainer/profile id για την κράτηση.",
      });
      return;
    }
  ...
  const submitBooking = async () => {
    ...
    if (!pricing) {
      setBanner({
        ...
        message:
          pricingMessage ||
          "Ο προπονητής δεν έχει ορίσει ακόμη τιμές στο base_price.",
      });
      return;
    }
