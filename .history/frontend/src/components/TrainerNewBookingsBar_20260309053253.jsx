    ...
    >
      <div
        className={[
          ...
          "border-yellow-400/25 bg-zinc-800/85",
          "transition-all duration-200",
          "hover:-translate-y-[1px] hover:bg-zinc-800/95 hover:border-yellow-400/45",
      ...
      >
        <div className="relative flex items-start gap-3">
          <div className="relative">
            ...
            <span className="absolute -left-0.5 -top-0.5 h-2.5 w-2.5 rounded-full bg-yellow-400 shadow-[0_0_0_3px_rgba(39,39,42,1)]" />
          </div>
          ...
          <div className="min-w-0 flex-1">
            <div className="flex items-center justify-between gap-2">
              <div className="min-w-0 flex items-center gap-2">
                ...
                {b.is_online ? (
                  <Wifi className="h-3.5 w-3.5 shrink-0 text-yellow-300/90" />
                ) : (
                  <span
                    className="h-2.5 w-2.5 shrink-0 rounded-full bg-yellow-300/90"
              ...
              <span className="shrink-0 rounded-full border border-yellow-400/20 bg-yellow-400/12 px-2 py-0.5 text-[10px] font-medium text-yellow-200">
                Εκκρεμεί
              </span>
            </div>
            ...
            {isNew ? (
              <div className="mt-1">
                <span className="inline-flex items-center rounded-full border border-white/10 bg-white/6 px-2 py-0.5 text-[10px] font-medium text-white/70">
                  ΝΕΟ
                </span>
              </div>
            ) : null}
      ...
      <div className="overflow-hidden rounded-[18px] border border-white/10 bg-zinc-800/65 px-3 py-2.5">
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="mt-2 ml-auto h-3.5 w-14 rounded bg-white/8 animate-pulse" />
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="mx-1.5 sm:mx-4 -mt-4 sm:-mt-1 md:mt-4 mb-4 md:mb-6 pt-2 md:pt-3"
      >
