...
{/* Calendar grid - transparent backgrounds on mobile, contained on larger screens */}
                    ...
                    >
                      <div className="rounded-3xl border border-white/10 bg-white/[0.02] p-4 sm:p-5 lg:border-0 lg:bg-transparent lg:p-0">
...
{/* Mobile full-bleed: no inner containers on mobile */}
                        <div className="-mx-4 mb-5 flex items-center gap-4 border-y border-emerald-500/15 bg-emerald-500/10 px-4 py-4 sm:-mx-5 sm:px-5 md:mx-0 md:rounded-2xl md:border md:px-4">
