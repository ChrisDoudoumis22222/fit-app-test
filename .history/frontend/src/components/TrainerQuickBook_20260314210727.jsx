...
export default function TrainerQuickBook({
  ...
  const renderDesktopView = () => (
    <Glass className="hidden sm:block overflow-hidden rounded-[28px] border border-zinc-800/90 bg-[rgba(10,12,17,.82)] shadow-[0_18px_60px_rgba(0,0,0,.38)]">
      {baseStyles}
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="mt-2 flex flex-wrap items-center gap-2">
                ...
                <span className="inline-flex items-center rounded-full border border-emerald-500/10 bg-emerald-500/10 px-2.5 py-1 text-[11px] text-emerald-200/92">
      ...
      <div className="qb-scroll max-h-[82vh] overflow-y-auto px-4 py-4">
        <div className="space-y-4">
          <Tile className="rounded-[24px] border border-zinc-800/90 bg-[linear-gradient(180deg,rgba(24,24,27,.62),rgba(12,12,14,.68))] p-4">
            <div className="space-y-4">
              <div>
            ...
            <div className="space-y-3">
              <div className="flex flex-wrap items-start justify-between gap-3">
                <div className="min-w-0">
                  ...
                  <div className="mt-2 flex flex-wrap items-center gap-2">
                    ...
                    <span className="inline-flex items-center rounded-full border border-amber-500/10 bg-amber-500/10 px-2.5 py-1 text-[11px] text-amber-200/92">
                      {busyCount} κατειλημμένες
                    </span>

                    <span className="inline-flex items-center rounded-full border border-zinc-800 bg-zinc-900/70 px-2.5 py-1 text-[11px] text-white/62">
              ...
              {!sched ? (
                ...
                <div className="bg-transparent py-1">
                  <div className="qb-scroll max-h-[36vh] overflow-y-auto pr-1">
                    {loadingDay ? (
                      ...
                      >
                        {slots.map(({ s, e, status }) => {
                          ...
                          if (status === "rest") {
                            cls += " border-zinc-800 bg-zinc-900/45 text-white/28 cursor-not-allowed"
                          } else if (status === "busy") {
                            cls += " border-amber-500/10 bg-amber-500/10 text-amber-100/80 cursor-not-allowed"
                          } else if (isSel) {
                            cls += " border-zinc-500/70 bg-zinc-800 text-white shadow-[0_8px_18px_rgba(0,0,0,.22)]"
                          } else {
                            cls += " border-emerald-500/10 bg-emerald-500/10 text-emerald-100/90 hover:bg-emerald-500/14"
                          }
          ...
          {err && (
            <div className="rounded-2xl border border-red-500/15 bg-red-500/10 px-3 py-3 text-sm text-red-200">
              {err}
            </div>
          )}

          {okMsg && (
            <div className="flex items-center gap-2 rounded-2xl border border-emerald-500/15 bg-emerald-500/10 px-3 py-3 text-sm text-emerald-200">
          ...
          <div className="sticky bottom-0 z-10 -mx-4 border-t border-zinc-800/90 bg-[rgba(12,12,15,.92)] px-4 pt-3 pb-4 backdrop-blur-xl">
            <div className="flex flex-col gap-3">
      ...
      <>
        ...
        <div className="fixed inset-0 z-[999] sm:hidden">
          <button
            ...
            className="qb-backdrop-in absolute inset-0 bg-black/72 backdrop-blur-md"
            onClick={() => onMobileClose && onMobileClose()}
          />

          <div className="absolute inset-x-0 bottom-0">
            <div className="qb-sheet-in mx-auto w-full max-w-md rounded-t-[30px] border border-zinc-800/90 bg-[#070a11] shadow-[0_-30px_80px_rgba(0,0,0,.6)]">
              <div className="flex justify-center pt-2 pb-1">
                <div className="h-1.5 w-12 rounded-full bg-zinc-700/90" />
              </div>

              <div className="qb-scroll max-h-[92dvh] overflow-y-auto px-0 pb-[env(safe-area-inset-bottom)] text-white">
                <div className="border-b border-zinc-800/90 px-4 pt-3 pb-4">
                  <div className="flex items-start gap-3">
                    <div className="grid h-10 w-10 shrink-0 place-items-center rounded-2xl bg-zinc-900/85 ring-1 ring-zinc-800/90">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="mt-2 flex flex-wrap items-center gap-2">
                        <span className="inline-flex items-center rounded-full border border-zinc-800 bg-zinc-900/70 px-2.5 py-1 text-[11px] text-white">
                          Ωράριο: {niceWindows}
                        </span>

                        <span className="inline-flex items-center rounded-full border border-emerald-500/10 bg-emerald-500/10 px-2.5 py-1 text-[11px] text-emerald-100">
                          {loadingDay || !sched ? "…" : `${availableCount} διαθέσιμες`}
                        </span>
                      </div>
                    </div>
                    ...
                    <button
                      type="button"
                      onClick={() => onMobileClose && onMobileClose()}
                      className="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl border border-zinc-800 bg-zinc-900/85 text-white transition hover:bg-zinc-800"
                    >
                      <X className="h-5 w-5" />
                    </button>
                  </div>
                ...
                <div className="space-y-4 px-4 py-4 text-white">
                  <Tile className="rounded-[24px] border border-zinc-800/90 bg-[linear-gradient(180deg,rgba(24,24,27,.62),rgba(12,12,14,.68))] p-4 text-white">
                    <div className="space-y-4">
                      <div>
                        ...
                        <div className="relative mt-2">
                          <input
                            type="date"
                            className="qb-date-mobile h-12 w-full rounded-2xl border border-zinc-700/80 bg-zinc-950/60 px-3 pr-12 text-base text-white focus:outline-none focus:ring-2 focus:ring-zinc-600/40"
                            value={date}
                            onChange={(e) => setDate(e.target.value)}
                          />
                      ...
                      <div className="flex flex-wrap items-start justify-between gap-3">
                        <div className="min-w-0">
                          ...
                          <div className="mt-2 flex flex-wrap items-center gap-2">
                            ...
                            <span className="inline-flex items-center rounded-full border border-amber-500/10 bg-amber-500/10 px-2.5 py-1 text-[11px] text-amber-100">
                              {busyCount} κατειλημμένες
                            </span>
                        ...
                        <button
                          ...
                          title="Ανανέωση διαθέσιμων"
                          onClick={() => setRefreshTick((t) => t + 1)}
                          className="inline-flex h-10 shrink-0 items-center justify-center gap-2 rounded-2xl border border-zinc-800 bg-zinc-900/80 px-3 text-sm text-white transition hover:bg-zinc-800"
                        >
                            ...
                            {loadingDay ? (
                              ...
                              <div className="grid grid-cols-3 gap-2">
                                {slots.map(({ s, e, status }) => {
                                  ...
                                  if (status === "rest") {
                                    cls += " border-zinc-800 bg-zinc-900/45 text-white/45 cursor-not-allowed"
                                  } else if (status === "busy") {
                                    cls += " border-amber-500/10 bg-amber-500/10 text-amber-100/82 cursor-not-allowed"
                                  } else if (isSel) {
                                    cls += " border-zinc-500/70 bg-zinc-800 text-white shadow-[0_8px_18px_rgba(0,0,0,.22)]"
                                  } else {
                                    cls += " border-zinc-800 bg-zinc-950/60 text-white hover:bg-zinc-900/80"
                                  }
                    ...
                    <div className="space-y-3">
                      <label className="block">
                        ...
                        <input
                          type="email"
                          placeholder="client@example.com"
                          className="mt-2 h-12 w-full rounded-2xl border border-zinc-700/80 bg-zinc-950/60 px-3 text-base text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-zinc-600/40"
                          value={email}
                          onChange={(e) => setEmail(e.target.value)}
                        />
                      ...
                      <label className="block">
                        ...
                        <textarea
                          rows={4}
                          placeholder="Οποιαδήποτε λεπτομέρεια"
                          className="mt-2 w-full rounded-2xl border border-zinc-700/80 bg-zinc-950/60 px-3 py-3 text-base text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-zinc-600/40"
                          value={note}
                          onChange={(e) => setNote(e.target.value)}
                        />
                      </label>
                  ...
                  {err && (
                    <div className="rounded-2xl border border-red-500/15 bg-red-500/10 px-3 py-3 text-sm text-red-100">
                      {err}
                    </div>
                  )}
                  ...
                  {okMsg && (
                    <div className="flex items-center gap-2 rounded-2xl border border-emerald-500/15 bg-emerald-500/10 px-3 py-3 text-sm text-emerald-100">
                      ...
                      <span className="flex-1 text-emerald-100">{okMsg}</span>
                      <button
                        type="button"
                  ...
                  <div className="sticky bottom-0 z-10 -mx-4 border-t border-zinc-800/90 bg-[#070a11]/95 px-4 pt-3 pb-[calc(env(safe-area-inset-bottom)+12px)] backdrop-blur-xl">
                    <div className="flex flex-col gap-3">
