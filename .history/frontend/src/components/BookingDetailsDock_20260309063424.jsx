...
function InfoRow({ icon: Icon, label, value }) {
  return (
    <div className="flex items-start gap-3 rounded-2xl bg-white/[0.035] px-3 py-3">
      <div className="grid h-9 w-9 shrink-0 place-items-center rounded-xl bg-white/[0.04] border border-transparent">
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-2xl bg-white/[0.03]">
              ...
              >
                ...
                <div className="grid h-9 w-9 place-items-center rounded-full bg-white/[0.04] border border-transparent">
                  {mobileExpanded ? (
