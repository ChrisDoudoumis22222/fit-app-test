...
function SectionHeader({
  ...
  return (
    <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between mb-7 lg:mb-9">
      <div className="min-w-0">
        <div className="inline-flex items-center gap-3 rounded-2xl border border-zinc-800 bg-zinc-900/70 px-3 py-2 mb-4">
        ...
        {description ? (
          <p className="mt-2 max-w-2xl text-sm sm:text-base lg:text-lg text-zinc-400 leading-relaxed">
            {description}
          </p>
        ) : null}
      </div>
                ...
                <div key={stat.key} className={spanLastOnMobile}>
                  <ScrollReveal delay={index * 0.05}>
                    ...
                    >
                      ...
                      <div className="mt-2 text-sm sm:text-[15px] font-semibold text-zinc-200 leading-snug">
                        {stat.label}
                      </div>

                      <div className="mt-2 text-xs sm:text-sm text-zinc-500 leading-relaxed">
                        {stat.hint}
                      </div>
                    </motion.div>
                  </ScrollReveal>
        ...
        <div className="h-full overflow-hidden rounded-2xl border border-zinc-800 bg-zinc-950/70 transition-all duration-300 hover:border-zinc-700 hover:bg-zinc-950">
          <div className="relative h-52 overflow-hidden border-b border-zinc-800">
            ...
            <div className="absolute bottom-4 left-4 right-4">
              <h3 className="line-clamp-2 text-lg sm:text-xl font-semibold leading-tight text-white">
                {post.title}
              </h3>
            </div>
          </div>
          ...
          <div className="flex h-[calc(100%-13rem)] flex-col p-5 lg:p-6">
            <p className="mb-5 flex-1 line-clamp-3 text-sm lg:text-base leading-relaxed text-zinc-300">
              {post.description}
            </p>
      ...
      <PremiumCard hover={false}>
        <div className="p-6 lg:p-8 xl:p-9">
          <div className="animate-pulse">
            <div className="mb-8">
              <div className="h-11 w-40 rounded-2xl bg-zinc-800 mb-4" />
              <div className="h-9 w-72 rounded bg-zinc-800 mb-3" />
        ...
        <div className="p-6 lg:p-8 xl:p-9">
          <ScrollReveal>
            <div className="rounded-2xl border border-dashed border-zinc-800 bg-zinc-950/40 px-6 py-14 text-center">
              ...
              <p className="mx-auto max-w-xl text-zinc-400 text-base leading-relaxed">
        ...
        <div className="p-6 lg:p-8 xl:p-9">
          <ScrollReveal>
            <SectionHeader
              icon={Star}
              title="Κριτικές"
              description="Αξιολογήσεις και εμπειρίες πελατών από πραγματικές συνεργασίες."
              meta={
                <div className="rounded-2xl border border-zinc-800 bg-zinc-900/70 px-4 py-3">
                  <div className="flex items-center gap-3 flex-wrap">
                    ...
                    <span className="text-sm text-zinc-400">
                      {reviews.length > 0 ? `(${reviews.length} κριτικές)` : "χωρίς κριτικές"}
                    </span>
                  </div>
                </div>
              }
                        ...
                        <div className="flex min-w-0 items-start gap-4">
                          ...
                          <div className="min-w-0">
                            <div className="mb-1 flex flex-wrap items-center gap-3">
                              <h4 className="truncate text-base lg:text-lg font-semibold text-zinc-100">
