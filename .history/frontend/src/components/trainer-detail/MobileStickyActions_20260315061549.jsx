...
export default function MobileStickyActions({
  ...
  return (
    <>
      <AnimatePresence>
        {showScrollButton && showScrollTop ? (
          <motion.div
            ...
            className="sm:hidden fixed left-4 bottom-[calc(env(safe-area-inset-bottom,0px)+6.9rem)] z-[9998] pointer-events-none"
          >
            <button
              type="button"
      ...
      <div className="sm:hidden fixed inset-x-0 bottom-0 z-[9997] pointer-events-none px-3 pb-[calc(env(safe-area-inset-bottom,0px)+1.4rem)]">
        <motion.div
