    ...
    <>
      <PremiumCard
        ...
        className={[
          ...
          "relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] w-screen max-w-none rounded-none border-0 bg-transparent shadow-none",
          "sm:static sm:left-auto sm:right-auto sm:ml-0 sm:mr-0 sm:w-full sm:max-w-[360px] sm:rounded-[28px] sm:border-x sm:bg-inherit sm:shadow-[inherit]",
          "lg:mx-0 lg:max-w-[380px] lg:self-start",
        ].join(" ")}
      >
        <div className="p-0 pb-24 sm:p-4 lg:p-4.5">
          <div className="relative overflow-hidden rounded-none border-0 bg-transparent shadow-none sm:rounded-[24px] sm:border sm:border-zinc-700/50 sm:bg-zinc-900/30 sm:shadow-[0_10px_40px_rgba(0,0,0,0.28)]">
            <img
              src={photo}
          ...
          <div className="mt-3.5 space-y-3.5 px-3 sm:mt-4 sm:space-y-4 sm:px-0">
