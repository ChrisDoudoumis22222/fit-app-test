...
import { Calendar, Star, Wifi } from "lucide-react"
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-[999] lg:hidden bg-black/80 backdrop-blur-xl border-t border-zinc-700/50 p-4 pb-[calc(env(safe-area-inset-bottom)+1rem)] pointer-events-none">
      <motion.button
        ...
        whileTap={{ scale: 0.98 }}
        className="pointer-events-auto w-full flex items-center justify-center px-6 py-4 rounded-2xl text-zinc-200 bg-gradient-to-r from-zinc-700 to-zinc-800 hover:from-zinc-600 hover:to-zinc-700 border border-zinc-600/50 shadow-xl backdrop-blur-xl"
      >
