            ...
            <div className="grid grid-cols-[1fr_auto] items-center gap-2">
              ...
              {showFavorite ? (
                <motion.button
                  ...
                  className={[
                    "grid h-[52px] w-[52px] place-items-center border border-white/10 backdrop-blur-md transition-all touch-manipulation",
                    liked
                      ? "rounded-full bg-red-500 text-white shadow-[0_10px_24px_rgba(239,68,68,0.32)]"
                      : "rounded-[18px] bg-black/60 text-white hover:bg-black/80",
                    likeBusy ? "opacity-80" : "",
                  ].join(" ")}
                  aria-label={
                    liked
