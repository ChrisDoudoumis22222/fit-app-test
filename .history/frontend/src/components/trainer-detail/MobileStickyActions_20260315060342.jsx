    ...
    <>
      <AnimatePresence>
        {showScrollButton && showScrollTop ? (
          <motion.div
            ...
            className="sm:hidden fixed left-4 bottom-[calc(env(safe-area-inset-bottom,0px)+5.9rem)] z-[9998] pointer-events-none"
          >
            <button
              type="button"
      ...
      <div className="sm:hidden fixed inset-x-0 bottom-0 z-[9997] pointer-events-none px-3 pb-[max(0.75rem,env(safe-area-inset-bottom))]">
        <div className="mx-auto w-full max-w-md">
          <div className="pointer-events-auto rounded-[26px] border border-zinc-200 bg-white p-2 shadow-[0_-10px_35px_rgba(0,0,0,0.12)]">
            <div className="grid grid-cols-[1fr_auto] items-center gap-2">
              <button
                type="button"
                onClick={handleBook}
                className="inline-flex min-h-[56px] w-full items-center justify-center gap-2 rounded-[18px] border border-zinc-200 bg-white px-4 py-3 text-sm font-semibold text-black shadow-sm transition hover:bg-zinc-50 active:scale-[0.99] touch-manipulation"
              >
              ...
              {showFavorite ? (
                <motion.button
                  ...
                  className={[
                    "grid h-[56px] w-[56px] place-items-center rounded-[18px] border bg-white transition-all touch-manipulation shadow-sm",
                    liked
