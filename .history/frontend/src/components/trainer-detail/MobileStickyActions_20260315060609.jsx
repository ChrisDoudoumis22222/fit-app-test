        ...
        <div className="mx-auto flex w-full max-w-md items-center gap-2">
          ...
          {showFavorite ? (
            <motion.button
              ...
              className={[
                "pointer-events-auto grid h-[56px] w-[56px] shrink-0 place-items-center rounded-[20px] border bg-white shadow-[0_8px_24px_rgba(0,0,0,0.10)] transition-all touch-manipulation",
                liked
