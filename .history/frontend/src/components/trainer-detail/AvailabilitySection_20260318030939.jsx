  ...
  return (
    <div className="space-y-2.5 sm:space-y-3">
      {Array.from({ length: 4 }).map((_, index) => (
        <div
          key={index}
          className="rounded-2xl bg-white/[0.025] px-4 py-3.5 backdrop-blur-[2px] sm:px-5 sm:py-4 animate-pulse"
        >
            ...
            <div className="space-y-2.5 sm:space-y-3">
              {normalizedRows.map((day) => {
                ...
                return (
                  <div
                    key={day.id}
                    className="rounded-2xl bg-white/[0.025] px-4 py-3.5 backdrop-blur-[2px] !transition-none hover:!transform-none hover:!translate-y-0 hover:!scale-100 hover:!shadow-none sm:px-5 sm:py-4"
                  >
                    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
