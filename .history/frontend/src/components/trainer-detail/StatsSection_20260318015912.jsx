...
function StatCard({ icon: Icon, label, value, delay = 0, rotate = "0deg" }) {
  return (
    ...
    >
      ...
      {/* subtle floating glass circle behind icon */}
      ...
      <div className="relative flex h-full flex-col justify-between">
        <div>
          <p className="text-[10px] font-semibold uppercase tracking-[0.22em] text-zinc-500 sm:text-[11px]">
            {label}
          </p>
        </div>

        <div className="mt-8 lg:mt-12">
          <p className="text-3xl font-bold tracking-tight text-zinc-100 sm:text-4xl xl:text-[2.6rem]">
            {value}
          </p>
        </div>
      </div>
