    ...
    >
      <div
        className={[
          ...
          "hover:-translate-y-[1px] hover:bg-zinc-800/95 hover:border-orange-400/40",
          ...
          <div className="min-w-0 flex-1">
            <div className="flex items-center justify-between gap-2">
              <div className="min-w-0 flex items-center gap-2">
                ...
                {b.is_online ? (
                  <Wifi className="h-3.5 w-3.5 shrink-0 text-white/60" />
                ) : (
                  <span
                    className="h-2.5 w-2.5 shrink-0 rounded-full bg-white/55"
