...
function buildRenderableSlots(baseWindows, breaks, booked, durationMin, stepMin) {
  const slots = []
...
export default function TrainerQuickBook({
  ...
  }, [sched, bookedIntervals, uiSession])
      ...
      <>
        ...
        <div className="fixed inset-0 z-[999] sm:hidden">
          ...
          <div className="absolute inset-x-0 bottom-0">
            <div className="qb-sheet-in w-full rounded-t-[30px] border border-zinc-800/90 bg-[#070a11] shadow-[0_-30px_80px_rgba(0,0,0,.6)]">
                  ...
                  <Tile className="p-0 text-white">
                    <div className="space-y-3">
                      ...
                      <div className="flex flex-wrap items-center gap-3 text-xs text-white">
                        <span className="inline-flex items-center gap-1">
                          <span className="inline-block h-2.5 w-2.5 rounded-full bg-emerald-400/90" />
                          <span className="text-white">Διαθέσιμες / Pending</span>
                        </span>
                        <span className="inline-flex items-center gap-1">
