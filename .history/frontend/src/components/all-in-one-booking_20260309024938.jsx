                  ...
                  {!hasDateSelection ? (
                    ...
                    >
                      <div className="mx-auto w-full max-w-none xl:max-w-[980px]">
                        ...
                        <div className="mb-3 grid grid-cols-7 gap-1.5 sm:gap-3 lg:gap-4">
                          {weekDays.map((day) => (
                            <div
                              key={day}
                              className="py-2 text-center text-[10px] font-semibold tracking-wider text-zinc-600 sm:text-xs"
                            >
                              {day}
                            </div>
                          ))}
                          ...
                          {calendarDays.map((day, idx) => {
                            ...
                            return (
                              <button
                                ...
                                className={cn(
                                  "relative aspect-square w-full rounded-[18px] p-0 text-sm transition-all duration-300 ease-out sm:rounded-[22px] sm:text-base lg:text-lg",
                                  "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/30",
                              ...
                              >
                                <span className="text-[14px] sm:text-base lg:text-[20px]">
                                  {day}
                                </span>

                                {hasSlots && inRange && !isSelected && (
                                  <span className="absolute bottom-[6px] left-1/2 h-1.5 w-1.5 -translate-x-1/2 rounded-full bg-emerald-400 sm:bottom-2 sm:h-2 sm:w-2 lg:h-2.5 lg:w-2.5" />
                                )}
                              </button>
                            );
                          })}
                    ...
                    <motion.section
                      ...
                      exit={{ opacity: 0, scale: 0.992 }}
                      transition={{ duration: 0.18, ease: "easeOut" }}
                      className="px-4 py-5 sm:px-5 sm:py-6 lg:min-h-full lg:px-8 lg:py-8"
                    >
                    ...
                    >
                      ...
                      <section className="px-0 sm:px-0">
                        <div className="rounded-none border-0 bg-transparent p-0 sm:rounded-3xl sm:border sm:border-white/10 sm:bg-white/[0.02] sm:p-5 lg:rounded-none lg:border-0 lg:bg-transparent lg:p-0">
                          <div className="mb-4 mx-4 rounded-2xl border border-emerald-500/15 bg-emerald-500/10 p-4 sm:mx-0 flex items-center gap-4">
                            <div className="flex h-10 w-10 items-center justify-center rounded-full bg-emerald-500/20">
                              <CheckCircle2 className="h-5 w-5 text-emerald-400" />
                            </div>
                            <div>
                          ...
                          <div className="grid gap-3 px-4 sm:px-0 sm:grid-cols-2 xl:grid-cols-3">
                            <div className="border-0 rounded-none bg-transparent p-0 sm:rounded-2xl sm:border sm:border-white/8 sm:bg-white/[0.03] sm:p-4">
                              <div className="text-xs text-zinc-500">Ημερομηνία</div>
                            ...
                            <div className="border-0 rounded-none bg-transparent p-0 sm:rounded-2xl sm:border sm:border-white/8 sm:bg-white/[0.03] sm:p-4 sm:col-span-2 xl:col-span-1">
