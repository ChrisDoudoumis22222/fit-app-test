...
function InfoRow({ icon, label, value }) {
  return (
    <div className="flex items-start gap-3 rounded-2xl bg-white/[0.03] px-3.5 py-3 sm:px-4">
      ...
      <div className="min-w-0">
        ...
        <div className="mt-1 text-sm font-medium leading-relaxed text-white sm:text-[15px]">
          {value}
        </div>
      </div>
    </div>
          ...
          >
            ...
            <div className="relative z-10 max-h-[calc(100dvh-24px)] overflow-y-auto px-4 py-4 sm:px-6 sm:py-6">
                ...
                {!logoFailed ? (
                  <div className="inline-flex items-center justify-center rounded-2xl bg-white px-5 py-3 sm:px-6 sm:py-4">
                    <img
                      ...
                      className="h-11 w-auto object-contain brightness-0 sm:h-13"
                    />
                  </div>
                ) : (
              ...
              <div className="mb-4 flex justify-center sm:mb-5">
                <div
                  className={cn(
                    "flex h-16 w-16 items-center justify-center rounded-2xl ring-1 sm:h-[72px] sm:w-[72px]",
                    status === "success"
              ...
              {/* Description */}
              <p className="mx-auto mt-2 max-w-[32ch] text-center text-[13px] leading-relaxed text-zinc-400 sm:text-sm">
                {status === "success"
                ...
                <>
                  ...
                  <div className="mt-5 space-y-2.5 sm:mt-6 sm:space-y-3">
                    ...
                    >
                      ...
                      <span>Προσθήκη στο ημερολόγιό</span>
                  ...
                  <div className="mt-4 border-t border-white/10 pt-3 sm:mt-5 sm:pt-4">
                    <p className="text-center text-[11px] leading-relaxed text-zinc-500 sm:text-xs">
                      Η κράτηση σου έχει καταχωρηθεί και βρίσκεται σε αναμονή
                      επιβεβαίωσης.
                    </p>
                  </div>
                </>
