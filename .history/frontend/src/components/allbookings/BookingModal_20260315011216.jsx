...
function statusMeta(status) {
  ...
  if (key === "accepted") {
    return {
      ...
      Icon: CheckCircle2,
      auraPrimary: "bg-emerald-400/16",
      auraSecondary: "bg-emerald-300/10",
      auraCore: "bg-emerald-300/30",
    };
  }
  ...
  if (key === "declined") {
    return {
      ...
      Icon: Ban,
      auraPrimary: "bg-rose-400/16",
      auraSecondary: "bg-rose-300/10",
      auraCore: "bg-rose-300/30",
    };
  }
  ...
  return {
    ...
    Icon: Clock3,
    auraPrimary: "bg-amber-400/14",
    auraSecondary: "bg-amber-300/9",
    auraCore: "bg-amber-300/26",
  };
}
...
function SkeletonStatBox() {
  return (
    <div className="rounded-[18px] border border-white/8 bg-white/[0.03] px-4 py-3.5 shadow-[0_8px_20px_rgba(0,0,0,0.22)]">
...
function BookingModalSkeleton({ onClose }) {
  return (
    <div className="animate-in fade-in duration-300">
      ...
      <div className="mb-4 flex items-center gap-3 rounded-[20px] border border-white/8 bg-white/[0.03] px-3.5 py-3">
      ...
      <div className="mt-4 space-y-3">
        <div className="rounded-[22px] border border-white/8 bg-white/[0.03] px-4 py-4 shadow-[0_12px_28px_rgba(0,0,0,0.34)]">
          <div className="flex items-start justify-between gap-3">
            <SkeletonInfoRow />
...
function Card({ className = "", children }) {
  return (
    <div
      className={[
        "rounded-[22px] border border-white/8 bg-white/[0.03] transition-colors duration-300",
        "shadow-[0_12px_28px_rgba(0,0,0,0.34)] backdrop-blur-sm",
        className,
      ].join(" ")}
    >
      {children}
...
function StatBox({ label, value }) {
  return (
    <div className="rounded-[18px] border border-white/8 bg-white/[0.03] px-4 py-3.5 shadow-[0_8px_20px_rgba(0,0,0,0.22)] backdrop-blur-sm">
...
function InfoRow({ icon: Icon, label, value }) {
  return (
    <div className="flex items-start gap-3">
      <div className="grid h-11 w-11 shrink-0 place-items-center rounded-[16px] border border-white/8 bg-white/[0.04] text-white/70">
...
function ActionBtn({
  ...
  const styles = {
    decline: "border-white/10 text-white/78 hover:bg-white/[0.05]",
    accept: "border-white/10 text-white/92 hover:bg-white/[0.05]",
    neutral: "border-white/10 text-white/80 hover:bg-white/[0.05]",
  };
  ...
  return (
    <button
      ...
      disabled={disabled}
      className={[
        "inline-flex min-h-[52px] items-center justify-center gap-2 rounded-[18px] border bg-white/[0.02] px-4 py-3 text-[15px] font-semibold backdrop-blur-sm transition",
  ...
  return (
    <AnimatePresence mode="wait" initial={false}>
      <motion.div
        ...
        className="mb-4 flex items-center gap-3 rounded-[20px] border border-white/8 bg-white/[0.03] px-3.5 py-3 backdrop-blur-sm"
      >
        <div className="grid h-10 w-10 shrink-0 place-items-center rounded-[14px] border border-white/8 bg-white/[0.04] text-white/80">
          <meta.Icon className="h-[18px] w-[18px]" />
        </div>

        <div className="min-w-0">
          <p className="text-[14px] font-semibold text-white">{meta.title}</p>
          <p className="mt-0.5 text-[12px] text-white/55">{meta.label}</p>
        </div>
      </motion.div>
    </AnimatePresence>
  );
...
function LockedNotice() {
  return (
    <motion.div
      ...
      className="mt-3 rounded-[18px] border border-white/8 bg-white/[0.03] px-4 py-3 backdrop-blur-sm"
    >
      <div className="flex items-start gap-3">
        <div className="grid h-10 w-10 shrink-0 place-items-center rounded-[14px] border border-white/8 bg-white/[0.04] text-white/80">
  ...
  return (
    <div className="sm:hidden">
      <motion.button
        type="button"
        aria-label="Κλείσιμο"
        className="fixed inset-0 z-[119] bg-black/76 backdrop-blur-[4px]"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
        onClick={onClose}
      ...
      <motion.div
        ...
        className="fixed inset-x-0 bottom-0 z-[120] max-h-[92dvh] overflow-hidden rounded-t-[30px] border border-white/[0.06] bg-[#040506] shadow-[0_-24px_80px_rgba(0,0,0,0.86)]"
      >
        <StatusAuraBackground meta={meta} />

        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,#101214_0%,#050607_42%,#030405_100%)]" />
      ...
      <div className="fixed inset-0 z-[120] overflow-y-auto">
        <div className="flex min-h-full items-start justify-center px-4 py-6 lg:px-6 lg:py-8">
          <motion.div
            ...
            transition={{ duration: 0.24, ease: [0.22, 1, 0.36, 1] }}
            className="relative w-full max-w-2xl overflow-hidden rounded-[30px] border border-white/[0.06] bg-[#040506] p-5 shadow-[0_28px_90px_rgba(0,0,0,0.88)]"
          >
            <StatusAuraBackground meta={meta} />
      ...
      <div className="mt-4 space-y-3">
          ...
          <div className="flex items-start justify-between gap-3">
            ...
            <AnimatePresence mode="wait" initial={false}>
              <motion.span
                ...
                className="inline-flex shrink-0 items-center gap-1.5 rounded-full border border-white/10 bg-white/[0.04] px-3 py-1.5 text-[11px] font-semibold text-white/85"
              >
        ...
        <Card className="overflow-hidden px-4 py-4">
          ...
          >
            ...
            <div className="grid h-10 w-10 place-items-center rounded-full border border-white/8 bg-white/[0.04] text-white/70">
              {expanded ? (
