...
function statusMeta(status) {
  ...
  if (key === "accepted") {
    return {
      ...
      Icon: CheckCircle2,
      badge:
        "border-emerald-500/35 bg-emerald-500/15 text-emerald-300 shadow-[0_0_0_1px_rgba(16,185,129,0.04)]",
      banner:
        "border-emerald-500/30 bg-emerald-500/10 text-emerald-200 shadow-[0_10px_30px_rgba(16,185,129,0.07)]",
      iconWrap:
        "bg-emerald-500/18 text-emerald-300 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]",
      accentGlow: "bg-emerald-400/18",
      accentGlass:
        "from-emerald-500/18 via-emerald-400/10 to-transparent border-emerald-400/16",
      accentLine: "from-emerald-300/70 to-transparent",
      closeBtn:
        "border-emerald-400/10 bg-emerald-400/8 text-white/80 hover:bg-emerald-400/14 hover:text-white",
    };
  }
  ...
  if (key === "declined") {
    return {
      ...
      Icon: Ban,
      badge:
        "border-rose-500/35 bg-rose-500/15 text-rose-300 shadow-[0_0_0_1px_rgba(244,63,94,0.04)]",
      banner:
        "border-rose-500/30 bg-rose-500/10 text-rose-200 shadow-[0_10px_30px_rgba(244,63,94,0.07)]",
      iconWrap:
        "bg-rose-500/18 text-rose-300 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]",
      accentGlow: "bg-rose-400/18",
      accentGlass:
        "from-rose-500/18 via-rose-400/10 to-transparent border-rose-400/16",
      accentLine: "from-rose-300/70 to-transparent",
      closeBtn:
        "border-rose-400/10 bg-rose-400/8 text-white/80 hover:bg-rose-400/14 hover:text-white",
    };
  }
  ...
  return {
    ...
    Icon: Clock3,
    badge:
      "border-amber-500/30 bg-amber-500/12 text-amber-300 shadow-[0_0_0_1px_rgba(245,158,11,0.04)]",
    banner:
      "border-amber-500/25 bg-amber-500/[0.09] text-amber-200 shadow-[0_10px_30px_rgba(245,158,11,0.05)]",
    iconWrap:
      "bg-amber-500/16 text-amber-300 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]",
    accentGlow: "bg-amber-400/15",
    accentGlass:
      "from-amber-500/16 via-amber-400/10 to-transparent border-amber-400/14",
    accentLine: "from-amber-300/60 to-transparent",
    closeBtn:
...
function Card({ className = "", children }) {
  return (
    <div
      className={[
        "rounded-[22px] border border-white/[0.04] bg-[#0a0e14]",
...
function StatBox({ label, value }) {
  return (
    <div className="rounded-[18px] border border-white/[0.04] bg-[#0c1016] px-4 py-3.5 shadow-[0_8px_20px_rgba(0,0,0,0.22)]">
...
function ActionBtn({
  ...
  const styles = {
    decline:
      "border-rose-500/35 bg-rose-500/[0.05] text-rose-300 hover:bg-rose-500/[0.11] hover:border-rose-500/55",
    accept:
      "border-emerald-500/35 bg-emerald-500/[0.05] text-emerald-300 hover:bg-emerald-500/[0.11] hover:border-emerald-500/55",
    neutral: "border-white/10 bg-white/[0.02] text-white/80 hover:bg-white/5",
  };
  ...
  return (
    <div className="sm:hidden">
      ...
      <motion.div
        ...
        exit={{ y: "100%" }}
        transition={{ duration: 0.28, ease: [0.22, 1, 0.36, 1] }}
        className="fixed inset-x-0 bottom-0 z-[120] max-h-[92dvh] overflow-hidden rounded-t-[30px] border border-white/[0.04] bg-[#06080c] shadow-[0_-24px_60px_rgba(0,0,0,0.55)]"
      >
      ...
      <div className="fixed inset-0 z-[120] overflow-y-auto">
        <div className="flex min-h-full items-start justify-center px-4 py-6 lg:px-6 lg:py-8">
          <motion.div
            ...
            transition={{ duration: 0.24, ease: [0.22, 1, 0.36, 1] }}
            className="w-full max-w-2xl rounded-[30px] border border-white/[0.04] bg-[#06080c] p-5 shadow-[0_24px_70px_rgba(0,0,0,0.55)]"
          >
            {children}
          </motion.div>
        </div>
    ...
    <div className="relative z-[1] mb-4">
      <div className="flex items-start justify-between gap-3">
        ...
        <button
          ...
          onClick={onClose}
          className={[
            "relative z-[2] grid h-11 w-11 shrink-0 place-items-center rounded-full border transition",
            meta.closeBtn,
          ].join(" ")}
          aria-label="Κλείσιμο"
        >
        ...
        <div className="mt-4 space-y-3">
          ...
          <Card className="overflow-hidden px-4 py-4">
            ...
            >
              ...
              <div className="grid h-10 w-10 place-items-center rounded-full bg-white/[0.05] text-white/70 transition hover:bg-white/[0.08] hover:text-white">
                {expanded ? (
