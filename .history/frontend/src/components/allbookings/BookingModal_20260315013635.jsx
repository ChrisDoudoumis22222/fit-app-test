  ...
  return (
    <div className="fixed inset-0 z-[130]">
      ...
      <div className="absolute inset-0 flex items-center justify-center px-4">
        <div className="w-full max-w-md rounded-[26px] bg-[linear-gradient(180deg,#05070b_0%,#06080c_40%,#04060a_100%)] p-5 shadow-[0_24px_70px_rgba(0,0,0,0.55)]">
    ...
    <div className="fixed inset-0 z-[130]">
      ...
      <div className="absolute inset-0 flex items-center justify-center px-4">
        <motion.div
          ...
          transition={{ duration: 0.24, ease: [0.22, 1, 0.36, 1] }}
          className={[
            "w-full max-w-md rounded-[26px] border bg-[linear-gradient(180deg,#05070b_0%,#06080c_40%,#04060a_100%)] p-5 shadow-[0_24px_70px_rgba(0,0,0,0.55)]",
            tone.panel,
          ].join(" ")}
        >
  ...
  return (
    <div className="sm:hidden">
      ...
      <motion.div
        ...
        className="fixed inset-x-0 bottom-0 z-[120] max-h-[92dvh] overflow-hidden rounded-t-[30px] bg-[linear-gradient(180deg,#05070b_0%,#06080c_40%,#04060a_100%)] shadow-[0_-24px_60px_rgba(0,0,0,0.55)]"
      >
      ...
      <div className="fixed inset-0 z-[120] overflow-y-auto">
        <div className="flex min-h-full items-start justify-center px-4 py-6 lg:px-6 lg:py-8">
          <motion.div
            ...
            exit={{ opacity: 0, y: 16, scale: 0.985 }}
            transition={{ duration: 0.24, ease: [0.22, 1, 0.36, 1] }}
            className="w-full max-w-2xl rounded-[30px] bg-[linear-gradient(180deg,#05070b_0%,#06080c_40%,#04060a_100%)] p-5 shadow-[0_24px_70px_rgba(0,0,0,0.55)]"
          >
            {children}
          </motion.div>
        </div>
