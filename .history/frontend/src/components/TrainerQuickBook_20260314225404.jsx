...
export default function TrainerQuickBook({
  ...
  const selectedAvailableSlot = useMemo(
    () => slots.find((x) => x.s === selectedStart && x.status === "available"),
    [slots, selectedStart]
  )
  ...
  const canSubmit = useMemo(() => {
    ...
    return !!selectedAvailableSlot
  }, [trainerId, sched, cleanEmail, cleanUsername, selectedStart, selectedAvailableSlot])
  ...
  const validateAndGuide = () => {
    ...
    if (!sched) {
      nextErrors.date = "Δεν βρέθηκε διαθέσιμο ωράριο για αυτή τη μέρα."
    }
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      // NOTE stays optional -> no validation / no popup error for it
    ...
    <div className="hidden sm:block w-full h-full">
      ...
      <div className="px-0 py-0 h-full flex flex-col">
        <div className="flex flex-col gap-4 flex-1 overflow-y-auto pr-1">
          ...
          <Tile ref={desktopSlotsRef} className={cn("p-0 rounded-[24px]", fieldWrapClass("slots"))}>
            <div className="space-y-3">
              <div className="flex flex-wrap items-start justify-between gap-3">
                <div className="min-w-0">
                  <div className="flex items-center gap-2">
                    <Clock className="h-4 w-4 text-white/60 shrink-0" />
                    <p className="text-base font-semibold text-white/90">Ώρες ({uiSession}′)</p>
                  </div>
              ...
              {!sched ? (
                ...
                <div className="py-2 text-sm text-white/52">Ρεπό / χωρίς ωράριο για αυτή τη μέρα.</div>
              ) : (
          ...
          <Tile className="p-0">
            <div className="space-y-3">
              ...
              >
                ...
                />
                <p className="mt-1.5 text-xs text-white/45">Βάλε τουλάχιστον email ή όνομα.</p>
