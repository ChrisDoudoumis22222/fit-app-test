    ...
    <div className="fixed inset-0 z-[120]">
      ...
      <div className="hidden sm:flex absolute inset-0 items-center justify-center p-4">
        ...
        >
          ...
          <div className="relative flex-1 overflow-y-auto qb-scroll px-6 py-6">
            {PostCard ? (
      ...
      <div className="sm:hidden absolute inset-0">
        ...
        <div className="absolute inset-x-0 bottom-0 flex justify-center">
          ...
          >
            ...
            <div className="relative flex items-center justify-end border-b border-zinc-800/90 bg-black px-4 pt-3 pb-4">
              <button
                onClick={requestClose}
