          ...
          >
            ...
            <div className="flex flex-col items-center text-zinc-400 group-hover:text-zinc-300 transition-colors text-center px-4">
              ...
              <p className="text-sm text-zinc-500">
                Υποστήριξη πολλαπλών εικόνων • Μέγιστο 1MB η κάθε μία
              </p>
            </div>
          </label>
        </div>
    ...
    <>
      ...
      <div className="fixed inset-0 z-[80] sm:hidden">
        ...
        <div className="absolute inset-x-0 bottom-0">
          <div className="qb-sheet-in w-full rounded-t-[30px] border border-zinc-900 bg-black shadow-[0_-30px_80px_rgba(0,0,0,.9)] flex max-h-[92dvh] flex-col">
