  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={cn(
          "absolute right-2 top-2 z-10 inline-flex items-center justify-center rounded-full text-white transition-all duration-200",
...
export default function CreatePostModal({
  ...
  const renderForm = ({ mobile = false }) => (
    <div
      className={cn(
        "flex-1 overflow-y-auto qb-scroll",
