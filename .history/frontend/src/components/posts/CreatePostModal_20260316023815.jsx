        ...
        >
          ...
          <div className="relative px-5 pb-5 pt-7 sm:px-6 sm:pb-6">
            ...
            <div className="mt-5 text-center">
              <div
                className={cn(
                  "inline-flex items-center rounded-full border px-3 py-1 text-[11px] font-semibold tracking-[0.16em] uppercase",
                  isSuccess
            ...
            <div className="mt-6 space-y-2">
              <button
                type="button"
                onClick={onPrimary}
                className="w-full h-12 rounded-2xl bg-white text-black font-semibold transition hover:bg-zinc-100"
              >
              ...
              {!isSuccess && (
                <button
                  type="button"
                  onClick={onSecondary}
                  className="w-full h-11 rounded-2xl border border-zinc-700 bg-zinc-800 text-white transition hover:bg-zinc-700"
                >
                  Κλείσιμο
                </button>
              )}
          ...
          >
            ...
            >
              ...
              <div className="relative border-t border-white/10 px-6 py-4 bg-black/45 backdrop-blur-xl">
                <div className="flex items-center justify-between gap-3">
                  <div className="min-w-0">
                    <div className="text-sm text-zinc-400">{footerHint}</div>

                    {isDirty && !detailsComplete && (
                      <p className="mt-1 text-xs text-zinc-500">
                        Συμπλήρωσε πρώτα τα στοιχεία και μετά συνέχισε στις εικόνες.
                      </p>
                    )}

                    {isDirty && detailsComplete && !imagesComplete && (
                      <p className="mt-1 text-xs text-zinc-500">
                        Το επόμενο βήμα είναι να ανεβάσεις τουλάχιστον μία εικόνα.
                      </p>
                    )}
                  </div>
              ...
              >
                ...
                <div className="border-t border-zinc-800/90 bg-black px-4 pt-3 pb-[calc(env(safe-area-inset-bottom)+12px)]">
                  <div className="flex flex-col gap-3">
                    <div className="text-sm text-white/75">{footerHint}</div>
