...
const compressImageSmart = async (file, maxBytes = MAX_BYTES) => {
  ...
  if (/image\/gif|image\/svg\+xml/i.test(file.type)) {
    return file
  }
...
const ResultStatusCard = ({ result, onPrimary, onSecondary, mobile }) => {
  ...
  const badgeLabel =
    tone === "success" ? "SUCCESS" : tone === "decline" ? "DECLINED" : "ERROR"
    ...
    return (
      <AnimatePresence>
        ...
        >
          ...
          >
            <div className="relative overflow-hidden rounded-[30px] border border-white/8 bg-[radial-gradient(circle_at_top,rgba(16,42,36,0.45),transparent_38%),linear-gradient(180deg,rgba(12,13,18,0.98),rgba(8,9,12,0.98))] px-5 pb-5 pt-6 shadow-[0_24px_80px_rgba(0,0,0,0.55)]">
              <div
                className={cn(
    ...
    <AnimatePresence>
      ...
      >
        ...
        <motion.div
          ...
          className="relative w-full max-w-[390px]"
        >
          <div className="relative overflow-hidden rounded-[28px] bg-white px-5 pb-5 pt-6 shadow-[0_24px_70px_rgba(0,0,0,0.35)] sm:px-6 sm:pb-6 sm:pt-7">
            <div
              className={cn(
            ...
            <div className="relative mx-auto grid h-[118px] w-[118px] place-items-center">
              <div
                className={cn(
                  ...
                  isSuccess
                    ? "bg-gradient-to-br from-[#22c55e] via-[#10b981] to-[#059669]"
                    : "bg-gradient-to-br from-[#FF8A8A] via-[#FF5F7A] to-[#FF6B3D]",
                )}
              />

              <div className="absolute inset-[15px] rounded-full border border-white/25 bg-white/10" />

              <div className="relative grid h-14 w-14 place-items-center rounded-full bg-white shadow-[0_12px_30px_rgba(255,255,255,0.35)]">
                {isSuccess ? (
            ...
            <div className="mt-4 text-center">
              <h3 className="text-[24px] font-black tracking-tight text-zinc-900 sm:text-[26px]">
                {result.title}
              </h3>

              <p className="mx-auto mt-2 max-w-[290px] text-[14px] leading-6 text-zinc-500 sm:text-[15px]">
                {result.message}
              </p>
            </div>
            ...
            <button
              ...
              className={cn(
                ...
                isSuccess
                  ? "bg-gradient-to-r from-[#10b981] via-[#059669] to-[#047857] shadow-[0_16px_30px_rgba(16,185,129,0.30)] hover:brightness-105"
