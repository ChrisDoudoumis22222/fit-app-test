    ...
    >
      <div
        className={[
          ...
          "hover:-translate-y-[1px] hover:bg-zinc-800/95",
      ...
      >
        <div className="relative flex items-start gap-3">
          <div className="relative">
            ...
            <span className="absolute -left-0.5 -top-0.5 h-2.5 w-2.5 rounded-full bg-white/70 shadow-[0_0_0_3px_rgba(39,39,42,1)]" />
          </div>
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="mt-1 flex flex-wrap items-center gap-1.5">
              {b.is_online ? (
                <span className="inline-flex items-center gap-1 rounded-full border border-white/10 bg-white/6 px-2 py-0.5 text-[10px] font-medium text-white/75">
                  <Wifi className="h-3 w-3" />
                  Online
                </span>
              ) : null}

              <span className="inline-flex items-center rounded-full border border-white/10 bg-white/6 px-2 py-0.5 text-[10px] font-medium text-white/75">
                Εκκρεμεί
              </span>
