...
import BookingModalPopup from "./modals/BookingModalPopup";
...
const ActionButton: React.FC<{
  ...
  const base =
    "inline-flex h-11 w-full items-center justify-center gap-2 rounded-2xl px-4 text-[14px] sm:text-[15px] font-semibold transition-all duration-200 active:scale-[0.985] disabled:cursor-not-allowed disabled:opacity-50";
  ...
  return (
    <div className="w-full pb-6 lg:pb-0">
      ...
      <div className="mx-auto w-full max-w-7xl">
        <div className="relative overflow-hidden rounded-[24px] border border-white/10 bg-zinc-950/95 shadow-[0_20px_55px_rgba(0,0,0,0.5)]">
          ...
          <div className="relative z-10 lg:flex lg:min-h-[560px]">
            <aside className="hidden w-full max-w-[300px] shrink-0 border-r border-white/10 bg-white/[0.03] lg:flex lg:flex-col">
              ...
              <div className="mt-auto border-t border-white/10 p-4">
                <p className="text-xs leading-relaxed text-zinc-500">
                  Επίλεξε πρώτα ημερομηνία, μετά ώρα και στο τέλος ολοκλήρωσε
                  την κράτησή σου.
                </p>
              </div>
            </aside>
            ...
            <div className="min-w-0 flex-1 lg:overflow-hidden">
              <div className="border-b border-white/10 px-4 py-3.5 lg:hidden">
                <div className="flex items-center gap-3">
                  <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-white text-black shadow-[0_10px_25px_rgba(255,255,255,0.12)]">
                    <CalendarIcon className="h-5 w-5" />
                  </div>

                  <div className="min-w-0">
                    <h1 className="truncate text-[24px] font-bold leading-none text-white">
                      Κλείσε Ραντεβού
                    </h1>
                ...
                <AnimatePresence mode="wait" initial={false}>
                  {!hasDateSelection ? (
                    <motion.section
                      ...
                      className="w-full px-4 py-4 sm:px-5 sm:py-5 lg:px-8 lg:py-7 xl:px-10"
                    >
                      <div className="mx-auto w-full max-w-none xl:max-w-[920px]">
                        <div className="mb-5 flex items-start justify-between gap-4">
                          <div>
                            <p className="text-xs uppercase tracking-[0.18em] text-zinc-500">
                              Βήμα 1
                            </p>
                            <h2 className="mt-2 text-2xl font-bold tracking-tight text-white sm:text-3xl xl:text-[40px]">
                              {months[displayMonth]}
                            </h2>
                          ...
                          <div className="flex gap-2 sm:gap-3">
                            <button
                              ...
                              className={cn(
                                "flex h-11 w-11 items-center justify-center rounded-2xl transition-all duration-300 sm:h-12 sm:w-12",
                        ...
                        <div className="mb-3 grid grid-cols-7 gap-2 sm:gap-2.5 lg:gap-3">
                          {weekDays.map((day) => (
                            <div
                              key={day}
                              className="py-1.5 text-center text-[11px] font-semibold tracking-wider text-zinc-600 sm:text-xs"
                            >
                              {day}
                            </div>
                          ))}
                          ...
                          {calendarDays.map((day, idx) => {
                            ...
                            return (
                              <button
                                ...
                                className={cn(
                                  "relative aspect-square w-full rounded-[20px] p-0 text-sm transition-all duration-300 ease-out sm:text-base lg:text-[17px]",
                                  "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/30",
                                  "disabled:pointer-events-none",
                                  !day && "invisible",
                                  isSelected
                                    ? "scale-[1.03] bg-white font-bold text-zinc-900 shadow-[0_16px_34px_rgba(255,255,255,0.16)]"
                                    : hasSlots && inRange
                                    ? "bg-white/[0.05] font-semibold text-white hover:scale-[1.02] hover:bg-white/10 active:scale-95"
                                    : isToday
                              ...
                              >
                                <span className="text-[14px] sm:text-base lg:text-[18px]">
                                  {day}
                                </span>
                                {hasSlots && inRange && !isSelected && (
                                  <span className="absolute bottom-2 left-1/2 h-2 w-2 -translate-x-1/2 rounded-full bg-emerald-400" />
                                )}
                              </button>
                            );
                          })}
                        ...
                        {loading && (
                          <div className="flex items-center justify-center gap-3 pt-6 text-zinc-500">
                    ...
                    <motion.section
                      ...
                      exit={{ opacity: 0, scale: 0.992 }}
                      transition={{ duration: 0.18, ease: "easeOut" }}
                      className="rounded-3xl border border-white/10 bg-white/[0.02] p-4 sm:p-5 lg:min-h-full lg:rounded-none lg:border-0 lg:bg-transparent lg:p-7"
                    >
                      ...
                      <div className="mb-4 flex items-center gap-4 rounded-2xl border border-emerald-500/15 bg-emerald-500/10 p-3.5">
                      ...
                      <div className="mb-4 grid grid-cols-2 gap-2 lg:flex lg:flex-wrap">
                        {[
                          ...
                          <button
                            ...
                            disabled={count === 0}
                            className={cn(
                              "flex items-center justify-center gap-2 rounded-xl px-4 py-2.5 text-sm font-medium transition-all duration-200",
                              "disabled:pointer-events-none disabled:opacity-30",
                              selectedPeriod === key
                      ...
                      {daySlots.length === 0 ? (
                        <div className="flex items-center gap-4 rounded-2xl border border-amber-500/20 bg-amber-500/10 p-4 text-amber-200">
                          <AlertTriangle className="h-5 w-5 shrink-0 text-amber-400" />
                          <p className="text-sm">
                            Δεν υπάρχουν διαθέσιμα ραντεβού. Δοκίμασε άλλη
                            περίοδο.
                          </p>
                        </div>
                      ) : (
                            ...
                            {daySlots.map((slot) => {
                              ...
                              return (
                                <button
                                  ...
                                  className={cn(
                                    "group relative flex h-14 flex-col items-center justify-center rounded-2xl transition-all duration-300 ease-out lg:h-16",
                                    "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/30",
                                    selected
                                      ? "scale-[1.02] bg-white text-zinc-900 shadow-xl shadow-white/20"
                    ...
                    <motion.section
                      ...
                      className="space-y-5"
                    >
                      <section className="rounded-3xl border border-white/10 bg-white/[0.02] p-4 sm:p-5 lg:rounded-none lg:border-0 lg:bg-transparent lg:p-7">
                        <div className="mb-4 flex items-start justify-between gap-4">
                          <div>
                            <p className="text-xs uppercase tracking-[0.18em] text-zinc-500">
                              Βήμα 3
                        ...
                        <textarea
                          ...
                          className="min-h-[110px] w-full resize-none rounded-2xl border border-white/8 bg-white/[0.03] px-5 py-4 text-white placeholder:text-zinc-600 transition-all hover:bg-white/[0.05] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/20"
                        />
                      </section>
