...
const hhmm = (t) => String(t || "").match(/^(\d{1,2}:\d{2})/)?.[1] ?? String(t || "");
...
export const AllInOneBooking = ({
  ...
  const availableDateSet = useMemo(() => new Set(Array.from(byDate.keys())), [byDate]);
  ...
  const handleContinue = async () => {
    ...
    try {
      ...
      const msg = e instanceof Error ? e.message : "Κάτι πήγε στραβά. Παρακαλώ δοκίμασε ξανά.";
                  ...
                  {!hasDateSelection ? (
                    ...
                    >
                      ...
                      <div className="mb-5 grid grid-cols-2 gap-2 lg:flex lg:flex-wrap">
                        {[
                          { key: "all", label: "Όλες", icon: null, count: periodCounts.all },
                          { key: "morning", label: "Πρωί", icon: Sun, count: periodCounts.morning },
                          {
                            key: "afternoon",
                            label: "Απόγευμα",
                            icon: Sunset,
                          ...
                          { key: "night", label: "Βράδυ", icon: Moon, count: periodCounts.night },
                      ...
                      <section className="rounded-3xl border border-white/10 bg-white/[0.02] p-4 sm:p-5 lg:rounded-none lg:border-0 lg:bg-transparent lg:p-8">
                        ...
                        <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-3">
                          <div className="rounded-2xl border border-white/8 bg-white/[0.03] p-4">
                            <div className="text-xs text-zinc-500">Ημερομηνία</div>
                            <div className="mt-1 font-semibold text-white">{fmtDate(selectedSlot.date)}</div>
                          </div>
