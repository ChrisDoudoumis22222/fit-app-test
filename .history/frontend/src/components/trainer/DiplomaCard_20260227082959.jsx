          ...
          <div className="mx-auto max-w-xl flex flex-col items-center text-center">
            ...
            <div className="w-full flex justify-center">
              {hasDiploma ? (
                previewIsImage ? (
                  <div className="relative">
                    <img
                      src={diplomaUrl}
                      alt="Πτυχίο"
                      className="max-h-64 w-auto max-w-full rounded-3xl object-contain bg-white/5 shadow-[0_18px_55px_rgba(0,0,0,.45)]"
                    />
                    <div className="pointer-events-none absolute -inset-4 -z-10 rounded-[32px] bg-white/5 blur-xl" />
                  </div>
                ) : (
                  <div className="w-full max-w-md rounded-3xl bg-white/5 border border-white/10 p-5 text-left shadow-[0_18px_55px_rgba(0,0,0,.35)]">
                ...
                <div className="w-full max-w-md rounded-3xl bg-white/[0.04] border border-dashed border-white/10 p-8">
