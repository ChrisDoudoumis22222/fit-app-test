  ...
  return (
    <motion.div
      ...
      className={[
        ...
        // mobile: fully flat / no section surround
...
function TrainerProfileForm({ profile, onAfterSave, pvDebug = false }) {
  ...
  const currentCategory = useMemo(() => {
    ...
    return (
      TRAINER_CATEGORIES.find((cat) => cat.value === form.specialty) || null
    );
  }, [form.specialty]);
  ...
  return (
    <>
      <style>{`
        ...
        /* mobile: no section background / no section halo */
            ...
            >
              <div className="space-y-5">
                ...
                <div className="space-y-12">
                  ...
                  <div
                    className={cn(
                      "mt-16 sm:mt-20 h-full rounded-2xl border-0 bg-transparent p-5 sm:p-6",
                      dirtyMap.isOnline
