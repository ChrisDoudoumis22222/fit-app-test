...
export default function BookingDetailsDock({
  ...
  return (
    <Glass className="p-4 sm:p-5 h-fit">
      ...
      {!id ? null : loading ? (
        ...
        <>
          ...
          <ul className="space-y-3 text-gray-300">
            ...
            {!!full?.trainer_name && (
              <Li icon={User} label="Προπονητής" value={full.trainer_name} />
            )}
          ...
          <div className="mt-6 flex flex-col sm:flex-row items-stretch sm:items-center gap-3 justify-end">
            ...
            {status === "pending" && (
              <>
                <Button variant="secondary" size="md" onClick={() => setDecline(true)}>
                  Απόρριψη
                </Button>
                <Button variant="primary" size="md" onClick={() => setAccept(true)}>
                  Αποδοχή
                </Button>
              </>
            )}
