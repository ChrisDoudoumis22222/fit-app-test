      ...
      {isOpen && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative w-full max-w-[380px] overflow-hidden rounded-[28px] border border-white/10 bg-zinc-950/95 shadow-[0_24px_70px_rgba(0,0,0,0.82)] sm:max-w-md"
          >
            ...
            <div className="relative z-10 px-4 py-4 sm:px-6 sm:py-6">
                ...
                <div
                  className={cn(
                    ...
                    status === "success"
                      ...
                      : "bg-red-500/12 text-red-300 ring-1 ring-red-500/20"
                  )}
                >
                  {status === "success" ? (
              ...
              >
                {status === "success" ? "Η κράτηση καταχωρήθηκε" : "Η κράτηση απέτυχε"}
              </h2>

              <p className="mx-auto mb-4 max-w-[34ch] text-center text-[13px] leading-relaxed text-zinc-400 sm:mb-5 sm:text-sm">
                {status === "success"
                  ? "Έλεγξε προσεκτικά τα στοιχεία της κράτησής σου και πρόσθεσέ τη στο ημερολόγιό σου."
              ...
              {status === "success" && bookingDetails ? (
                <>
                  ...
                  <div className="mb-4 flex items-center gap-2.5 rounded-2xl border border-white/8 bg-white/[0.03] p-3 sm:mb-5">
                    ...
                    <span className="text-[13px] text-zinc-300 sm:text-sm">
                      Θα λάβεις επιβεβαίωση στο email σου εντός 24 ωρών.
                    </span>
                  </div>
      ...
      <div className="mx-auto w-full max-w-6xl">
        <div className="relative overflow-hidden rounded-[28px] border border-white/10 bg-zinc-950/95 shadow-[0_24px_70px_rgba(0,0,0,0.55)]">
          ...
          <div className="relative z-10 lg:flex">
            ...
            {/* Main content */}
            <div className="px-4 py-4 sm:px-5 sm:py-5 lg:p-0">
              {/* Mobile header */}
