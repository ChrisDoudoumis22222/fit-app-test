...
> = ({
  ...
  const base =
    "inline-flex items-center justify-center rounded-xl font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/40 disabled:pointer-events-none disabled:opacity-50";
...
> = ({ className = "", ...props }) => (
  <textarea
    className={`flex min-h-[96px] w-full rounded-2xl border border-white/10 bg-white/8 px-4 py-3 text-sm text-white placeholder:text-white/45 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/20 disabled:cursor-not-allowed disabled:opacity-50 resize-none ${className}`}
    {...props}
  />
);
    ...
    >
      ...
      >
        ...
        <div className="relative z-10 p-8">
          ...
          <h2 className="text-2xl font-bold text-center text-zinc-100 mb-4">
            Επιτυχής Κράτηση! 🎉
          </h2>
...
export const AllInOneBooking: React.FC<AllInOneBookingProps> = ({
  ...
  return (
    <div className="w-full min-h-screen md:flex md:items-center md:justify-center md:p-6 xl:p-8">
      <div className="w-full md:max-w-4xl xl:max-w-6xl md:mx-auto">
        {banner && (
          <NotificationBanner
            type={banner.type}
            title={banner.title}
        ...
        <div className="w-full md:backdrop-blur-xl md:bg-black/20 md:border md:border-white/10 md:rounded-[28px] md:shadow-2xl md:overflow-hidden">
          {/* Header */}
          <div className="flex items-center justify-between px-4 py-4 md:px-6 md:py-6 md:border-b md:border-white/10 md:bg-white/5">
            <div className="w-6" />
          ...
          <div
            className={`px-4 pb-6 md:px-6 md:pb-6 lg:px-8 lg:pb-8 pt-3 md:pt-6 transition-all duration-300 ${
              hasDateSelection
                ? "grid grid-cols-1 xl:grid-cols-[minmax(420px,520px)_1fr] gap-6 xl:gap-8"
                : "flex justify-center"
            }`}
          >
            {/* Calendar column */}
            ...
            >
              <div className="rounded-[24px] border border-white/8 bg-gradient-to-br from-white/[0.04] to-white/[0.015] p-4 md:p-5 lg:p-6 shadow-[0_0_0_1px_rgba(255,255,255,0.02)]">
                <div className="flex items-center justify-between gap-3 mb-4">
                  ...
                  <div className="flex gap-2">
                    <CustomButton
                      ...
                      className="h-10 w-10 p-0 bg-white/[0.04] hover:bg-white/[0.08] border border-white/6 text-white disabled:opacity-30"
                  ...
                  {calendarDays.map((day, idx) => {
                    ...
                    return (
                      <CustomButton
                        ...
                        className={[
                          "h-12 md:h-[58px] w-full p-0 text-sm md:text-base relative overflow-hidden rounded-2xl border transition-all duration-200",
                          !day ? "invisible" : "",
                          isSelected
                            ? "bg-white text-black border-white shadow-[0_0_0_2px_rgba(255,255,255,0.45)]"
                            : "bg-white/[0.03] text-white border-white/[0.05] hover:bg-white/[0.07] hover:border-white/[0.14]",
                          !inRange || !hasSlots ? "opacity-30" : "",
                        ].join(" ")}
                ...
                {!loading && !hasDateSelection && (
                  <div className="mt-5 rounded-2xl border border-white/8 bg-white/[0.03] px-4 py-3 text-sm text-white/65">
            ...
            {/* Right column */}
            {hasDateSelection && (
              <div className="space-y-5 transition-all duration-300" ref={timeSlotsRef}>
                <div className="rounded-[24px] border border-white/8 bg-gradient-to-br from-white/[0.04] to-white/[0.015] p-4 md:p-5 lg:p-6">
                  <div className="space-y-5">
                    ...
                    <div className="space-y-4">
                      ...
                      {daySlots.length === 0 ? (
                        <div className="rounded-2xl border border-amber-400/20 bg-amber-500/10 text-amber-100 px-4 py-5 flex items-center gap-3 text-sm md:text-base">
                          ...
                          {daySlots.map((slot) => {
                            ...
                            return (
                              <CustomButton
                                ...
                                className={[
                                  "group h-[58px] md:h-[64px] relative rounded-2xl border px-3",
                                  "justify-center",
                                  selected
                                    ? "bg-white text-black border-white shadow-[0_0_0_2px_rgba(255,255,255,0.35)] hover:bg-white"
                                    : "bg-white/[0.05] text-white border-white/[0.12] hover:bg-white/[0.09] hover:border-white/[0.22]",
                                ].join(" ")}
                                  ...
                                  <span className="absolute top-2.5 right-2.5 opacity-80">
                                    <Wifi
                                      className={`h-3.5 w-3.5 ${
                                        selected ? "text-black/65" : "text-white/70"
                                      }`}
                                    />
                                  </span>
                                )}
                    ...
                    {hasSlotSelection && (
                      <div className="pt-1">
                        <div className="inline-flex max-w-full items-center gap-2 rounded-full border border-white/12 bg-white/[0.05] px-4 py-2 text-sm text-white/80">
                ...
                {hasSlotSelection && (
                  <div
                    ref={notesRef}
                    className="rounded-[24px] border border-white/8 bg-gradient-to-br from-white/[0.04] to-white/[0.015] p-4 md:p-5 lg:p-6"
                  >
                    <div className="mb-3">
                      <h3 className="text-base md:text-lg font-semibold text-white">
                ...
                {hasSlotSelection && (
                  <div className="pt-1">
                    <CustomButton
                      ...
                      className={`w-full h-13 md:h-14 text-base md:text-lg font-semibold rounded-2xl ${
