...
const CATS = [
  ...
  "Προφίλ & Επαλήθευση",
  "Υπηρεσίες & Τιμές",
  "Διαθεσιμότητα & Ημερολόγιο",
  "Κρατήσεις",
  "Μηνύματα",
  "Περιεχόμενο (Posts)",
  "Πληρωμές & Εκκαθαρίσεις",
  "Αξιολογήσεις",
  "Αναφορές & Analytics",
  "Ειδοποιήσεις",
...
const FAQS = [
  item("create-account", "Πώς δημιουργώ λογαριασμό εκπαιδευτή;", "Ξεκίνημα", [
    "Κάνε σύνδεση/εγγραφή και επέλεξε «Είμαι Εκπαιδευτής».",
    "Συμπλήρωσε όνομα, email και ισχυρό κωδικό.",
    "Επιβεβαίωσε το email από το μήνυμα που θα λάβεις.",
  ], { tags: ["εγγραφή", "signup", "onboarding"] }),
  item(
    "complete-profile",
    "Πώς συμπληρώνω το προφίλ μου (βιογραφικό, ειδικότητες, avatar);",
    "Προφίλ & Επαλήθευση",
    [
      "Μετάβαση: Μενού → Προφίλ.",
      "Πρόσθεσε φωτογραφία, σύντομο βιογραφικό, ειδικότητες και τοποθεσία.",
      "Πάτησε «Αποθήκευση».",
    ],
    { tags: ["avatar", "ειδικότητες", "bio"] }
  ),
  item("verify-trainer", "Πώς γίνεται η επαλήθευση εκπαιδευτή;", "Προφίλ & Επαλήθευση", [
    "Μετάβαση: Προφίλ → Επαλήθευση.",
    "Ανέβασε τα ζητούμενα δικαιολογητικά (ταυτότητα, ΑΦΜ/επαγγελματικό).",
  ...
  item("add-services", "Πώς προσθέτω υπηρεσίες & τιμές;", "Υπηρεσίες & Τιμές", [
    "Μετάβαση: Μενού → Υπηρεσίες.",
    "Πρόσθεσε νέα υπηρεσία (τίτλος, περιγραφή, διάρκεια).",
    "Όρισε τιμή, νόμισμα και πολιτική ακύρωσης.",
    "«Αποθήκευση».",
  ], { tags: ["services", "pricing", "τιμοκατάλογος"] }),
  item("packages", "Πώς δημιουργώ πακέτα μαθημάτων;", "Υπηρεσίες & Τιμές", [
    "Στην καρτέλα Υπηρεσίες, επίλεξε «Νέο Πακέτο».",
    "Καθόρισε αριθμό συνεδριών, συνολική τιμή και ισχύ.",
  ...
  item("set-availability", "Πώς ρυθμίζω τη διαθεσιμότητά μου;", "Διαθεσιμότητα & Ημερολόγιο", [
    "Μετάβαση: Μενού → Ημερολόγιο.",
    "Κάνε κλικ στις ημέρες/ώρες για να ορίσεις διαθέσιμα slots.",
    "Πρόσθεσε εξαιρέσεις (αργίες, ρεπό).",
    "«Αποθήκευση».",
  ], { tags: ["calendar", "slots", "availability"] }),
  item(
    "sync-calendar",
    "Πώς συγχρονίζω εξωτερικό ημερολόγιο (Google/Apple/Outlook);",
    "Διαθεσιμότητα & Ημερολόγιο",
    [
      "Μετάβαση: Ημερολόγιο → Ρυθμίσεις Συγχρονισμού.",
      "Σύνδεσε τον λογαριασμό σου και επίλεξε ημερολόγια.",
  ...
  item("receive-bookings", "Πώς λαμβάνω κρατήσεις από πελάτες;", "Κρατήσεις", [
    "Βεβαιώσου ότι έχεις υπηρεσίες + διαθεσιμότητα ενεργές.",
    "Δώσε το δημόσιο προφίλ/σελίδα κρατήσεών σου στους πελάτες.",
  ...
  item("manage-bookings", "Πώς διαχειρίζομαι/εγκρίνω/ακυρώνω κρατήσεις;", "Κρατήσεις", [
    "Μετάβαση: Μενού → Κρατήσεις.",
    "Άνοιξε την κράτηση για «Έγκριση», «Ακύρωση» ή «Αναπρογραμματισμό».",
  ...
  item("no-show-policy", "Πώς ορίζω πολιτική καθυστέρησης/μη εμφάνισης (No-Show);", "Κρατήσεις", [
    "Μετάβαση: Υπηρεσίες → Πολιτικές.",
    "Όρισε χρόνο χάριτος (π.χ. 10') και χρεώσεις No-Show.",
    "«Αποθήκευση».",
  ], { tags: ["no show", "policy", "ακυρωτική"] }),
  item("use-messages", "Πώς επικοινωνώ με τους πελάτες (Μηνύματα/DM);", "Μηνύματα", [
    "Μετάβαση: Μενού → Μηνύματα.",
    "Επίλεξε συζήτηση ή άνοιξε νέα από την κράτηση.",
    "Στείλε κείμενο, αρχεία/πρόγραμμα, έτοιμες απαντήσεις.",
  ], { tags: ["chat", "dm", "supporting files"] }),
  item("create-post", "Πώς ανεβάζω Posts (περιεχόμενο, φωτογραφίες, βίντεο);", "Περιεχόμενο (Posts)", [
    "Μετάβαση: Οι Αναρτήσεις μου.",
    "Πρόσθεσε τίτλο, περιγραφή και εικόνες/βίντεο.",
    "Προεπισκόπηση → Δημοσίευση.",
  ], { tags: ["content", "feed", "media upload"] }),
  item("edit-post", "Πώς επεξεργάζομαι ή διαγράφω Post;", "Περιεχόμενο (Posts)", [
    "Άνοιξε το Post από το grid.",
    "Επίλεξε «Επεξεργασία» για αλλαγές ή «Διαγραφή».",
    "Οι αλλαγές αποθηκεύονται και ενημερώνεται το κοινό σου.",
  ], { tags: ["update", "delete", "posts"] }),
  item(
    "connect-payouts",
    "Πώς συνδέω λογαριασμό πληρωμών & λαμβάνω εκκαθαρίσεις;",
    "Πληρωμές & Εκκαθαρίσεις",
    [
      "Μετάβαση: Μενού → Πληρωμές.",
      "Συνδέσου με τον πάροχο πληρωμών (π.χ. Stripe Connect).",
      "Επιβεβαίωσε στοιχεία και ολοκλήρωσε KYC.",
      "Τα έσοδα εκκαθαρίζονται σύμφωνα με την πολιτική του παρόχου.",
    ],
    { tags: ["stripe", "iban", "payouts", "εκκαθάριση"] }
  ),
  item("refunds", "Πώς λειτουργούν οι επιστροφές χρημάτων;", "Πληρωμές & Εκκαθαρίσεις", [
    "Άνοιξε την κράτηση → «Επιστροφή».",
    "Επίλεξε ολική ή μερική επιστροφή και αιτιολογία.",
    "Ο πελάτης ενημερώνεται αυτόματα.",
  ], { tags: ["refund", "dispute", "chargeback"] }),
  item("reviews", "Πώς λαμβάνω και απαντώ σε αξιολογήσεις;", "Αξιολογήσεις", [
    "Μετά την ολοκλήρωση συνεδρίας, ζητείται αξιολόγηση πελάτη.",
    "Προβολή: Μενού → Αξιολογήσεις.",
  ...
  item("analytics", "Πού βλέπω στατιστικά & απόδοση;", "Αναφορές & Analytics", [
    "Μετάβαση: Μενού → Αναφορές.",
    "Δες κρατήσεις/έσοδα ανά περίοδο, ποσοστά πληρότητας και κορυφαίες υπηρεσίες.",
  ...
  item("notifications", "Πώς ρυθμίζω ειδοποιήσεις (email/Push/SMS);", "Ειδοποιήσεις", [
    "Μετάβαση: Μενού → Ρυθμίσεις → Ειδοποιήσεις.",
    "Ενεργοποίησε τα κανάλια που θέλεις και τους κανόνες (π.χ. νέες κρατήσεις, αλλαγές).",
    "«Αποθήκευση».",
  ], { tags: ["emails", "push", "sms"] }),
  item("two-factor", "Πώς ενεργοποιώ Διπλή Επαλήθευση (2FA);", "Ασφάλεια Λογαριασμού", [
    "Μετάβαση: Ρυθμίσεις Ασφάλειας.",
    "Επίλεξε εφαρμογή αυθεντικοποίησης ή SMS.",
    "Σκάναρε το QR/καταχώρησε κωδικό και αποθήκευσε τα backup codes.",
  ], { tags: ["2fa", "ασφάλεια", "otp"] }),
  item("change-email-pass", "Πώς αλλάζω email ή κωδικό;", "Ασφάλεια Λογαριασμού", [
    "Μετάβαση: Ρυθμίσεις Λογαριασμού.",
    "Ενημέρωσε email (με επιβεβαίωση) ή άλλαξε κωδικό με ισχυρά κριτήρια.",
    "«Αποθήκευση».",
  ], { tags: ["password", "credentials"] }),
  item("troubleshooting-booking", "Γιατί δεν εμφανίζονται διαθέσιμα slots;", "Βοήθεια & Επίλυση", [
    "Έλεγξε αν έχεις ορίσει διαθεσιμότητα στο Ημερολόγιο.",
    "Δες αν υπάρχει σύγκρουση με εξωτερικό συγχρονισμό (busy events).",
  ...
  item("contact-support", "Πώς επικοινωνώ με υποστήριξη;", "Βοήθεια & Επίλυση", [
    ...
    "Άνοιξε αίτημα με περιγραφή, screenshots και id κράτησης (αν υπάρχει).",
  ...
  item("group-sessions", "Πώς δημιουργώ ομαδικές συνεδρίες (group classes);", "Υπηρεσίες & Τιμές", [
    "Υπηρεσίες → Νέα Ομαδική Συνεδρία.",
    "Όρισε μέγιστο συμμετεχόντων, τιμή/άτομο και θέση.",
  ...
  item("reschedule-flow", "Πώς κάνω αναπρογραμματισμό κράτησης;", "Κρατήσεις", [
    "Άνοιξε κράτηση → «Αναπρογραμματισμός».",
    "Επίλεξε νέο slot από τη διαθεσιμότητά σου.",
    "Ο πελάτης ενημερώνεται αυτόματα.",
  ], { tags: ["reschedule", "change time"] }),
  item("policies", "Πού ορίζω όρους, ακυρωτική και αποποιήσεις ευθύνης;", "Υπηρεσίες & Τιμές", [
    "Υπηρεσίες → Πολιτικές.",
    "Πρόσθεσε όρους χρήσης/αποποιήσεις και κανόνες ακυρώσεων.",
  ...
  item("media-guidelines", "Οδηγίες μέσων (μέγεθος/όρια) για Posts;", "Περιεχόμενο (Posts)", [
    "Μέγιστο 1MB ανά εικόνα.",
    "Χρησιμοποίησε 4:3 ή 1:1 για καλύτερη προβολή στο grid.",
    "Απέφυγε υπερβολικό κείμενο πάνω στις εικόνες.",
  ], { tags: ["images", "limits", "ratios"] }),
  item("export-data", "Μπορώ να εξάγω τα δεδομένα μου (κρατήσεις/πελάτες);", "Αναφορές & Analytics", [
    "Αναφορές → Εξαγωγές.",
    "Επίλεξε τύπο (CSV/PDF) και εύρος ημερομηνιών.",
    "Κατέβασε το αρχείο από το κέντρο λήψεων.",
  ], { tags: ["export", "csv", "backup"] }),
  item("profile-link", "Πού βρίσκω τον δημόσιο σύνδεσμο προφίλ μου;", "Προφίλ & Επαλήθευση", [
    "Προφίλ → Προεπισκόπηση.",
    "Πάνω δεξιά: «Αντιγραφή συνδέσμου».",
    "Μοιράσου τον με τους πελάτες σου.",
  ...
  return (
    <div className="relative min-h-screen text-gray-100">
      ...
      <div
        className={`${
          showTrainerChrome
            ? "lg:pl-[calc(var(--side-w)+8px)] pl-0 lg:pt-0 pt-[var(--nav-h)]"
            : ""
        } transition-[padding]`}
      >
        <main className="mx-auto max-w-6xl w-full p-4 sm:p-6 space-y-8 pb-24">
            ...
            <div className="flex items-start justify-between gap-4">
              <div className="space-y-2">
                ...
                <p className="text-zinc-300">
                  Ό,τι χρειάζεσαι για να στήσεις προφίλ, υπηρεσίες, κρατήσεις και
                  πληρωμές.
                </p>
          ...
          >
            ...
            {/* Simpler, scrollable category chips */}
            <div className="mt-4">
              <CategoryChips
                categories={CATS}
                active={activeCat}
          ...
          {toRender.length === 0 ? (
            <div className="rounded-2xl border border-white/10 bg-gradient-to-b from-zinc-900/60 to-black/60 p-6 text-center text-zinc-300">
              ...
              <span className="text-zinc-200">«διαθεσιμότητα»</span>,{" "}
