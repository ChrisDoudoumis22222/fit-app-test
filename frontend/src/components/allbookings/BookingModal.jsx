            ...
            <div className="px-4 pt-4 pb-2 sm:px-0 sm:pt-0 sm:pb-0">
              <div className="flex items-start justify-between gap-3">
                ...
                <button
                  onClick={onClose}
                  className="
                    h-9 w-9 grid place-items-center shrink-0 text-white/75 hover:text-white
                    sm:h-12 sm:w-12 sm:rounded-2xl sm:border sm:border-white/10 sm:bg-white/5 sm:hover:bg-white/10
                  "
                  aria-label="Κλείσιμο"
                  title="Κλείσιμο"
                >
