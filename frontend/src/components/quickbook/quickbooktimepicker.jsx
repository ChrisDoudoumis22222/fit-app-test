...
function InfiniteWheelColumn({
  ...
  return (
    <div className="relative" style={{ height: WHEEL_HEIGHT }}>
      ...
      <div
        className="pointer-events-none absolute inset-x-2 top-1/2 z-20 -translate-y-1/2 rounded-2xl border border-white/20 bg-white/[0.06] shadow-[inset_0_1px_0_rgba(255,255,255,0.05),0_8px_24px_rgba(0,0,0,0.25)]"
        style={{ height: ITEM_HEIGHT }}
      />

      <div className="pointer-events-none absolute left-0 top-1/2 z-20 h-12 w-[3px] -translate-y-1/2 rounded-full bg-white/25" />
      <div className="pointer-events-none absolute right-0 top-1/2 z-20 h-12 w-[3px] -translate-y-1/2 rounded-full bg-white/25" />
            ...
            <button
              ...
              className={cn(
                ...
                active
                  ...
                  : "scale-[0.96] text-white hover:text-white"
              )}
              style={{
                height: ITEM_HEIGHT,
